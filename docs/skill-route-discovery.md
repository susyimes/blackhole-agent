...
11. Durable pipeline `operator_state` (also top-level fields) exports
   ...
   continue wakes. Residual export stays denied on continue surfaces even when
   residual route opens after residual_open_ready. Preferred
   ...
   `continue_cascade_wake_route_apply_follow_pin_call_next_call`,
   `continue_cascade_wake_route_apply_follow_pin_call_next_call_follow`,
   `continue_cascade_wake_route_apply_follow_pin_call_next_call_follow_pin`, and
   `continue_cascade_wake_route_apply_follow_pin_call_next_call_follow_pin_call` after
   run/record.
   ...
   `continue_cascade_wake_route_apply_follow_pin_call_next_call_follow`,
   `continue_cascade_wake_route_apply_follow_pin_call_next_call_follow_pin`, and
   `continue_cascade_wake_route_apply_follow_pin_call_next_call_follow_pin_call`. Durable
