...
def builtin_tcn_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="tcn-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, TCN_ACTUATION_GOAL, TCN_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_tcn"] = (
        not gate.accepted
        and live_goal != TCN_ACTUATION_GOAL
        and TCN_ACTUATION_ID not in live_done
