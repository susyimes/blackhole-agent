...
def builtin_total_spine_delivery_proof() -> dict[str, Any]:
    ...
    try:
        ...
        source_ok = (
            getattr(le_facade, "TOTAL_SPINE_DELIVERY_IMPL", None) is TOTAL_SPINE_DELIVERY_IMPL
            and getattr(le_facade, "builtin_total_spine_delivery_proof", None) is builtin_total_spine_delivery_proof
            and getattr(le_facade, "deliver_total_spine", None) is deliver_total_spine
            and callable(
