...
def builtin_icp_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="icp-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, ICP_ACTUATION_GOAL, ICP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_icp"] = (
        not gate.accepted
        and live_goal != ICP_ACTUATION_GOAL
        and ICP_ACTUATION_ID not in live_done
