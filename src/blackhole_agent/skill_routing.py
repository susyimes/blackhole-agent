    ...
    *,
        ...
        specs = (
            {
                ...
                "route_profiles": ("generic_skill_workflow", "source_cited_domain_research"),
                "selected_local_lane": "test",
                "validation_target": "zhengxi_views_skill_route_discovery_pass1_validation_lane",
                "validation_task": (
                    "validate zhengxi-views Agent Skill evidence through route_hints="
                    "skill_route_discovery and keep allowed local lanes bounded to "
                    "documentation, config, test, or code_patch while Qwen-AgentWorld, "
                    "Fundamental-Ava, and looper remain agent_harness_eval_required"
                ),
            },
        )
        ...
        specs = (
            {
                ...
                "validation_target": "zhengxi_views_current_pass1_skill_route_validation_lane",
                "validation_task": (
                    "validate the current zhengxi-views skill-route signal as a bounded local "
                    "test lane while keeping Qwen-AgentWorld, looper, and AgentChat in "
                    "agent_harness_eval_required before any runtime, scheduler, or code_patch route"
                ),
            },
        )
    elif current_072714_window:
        specs = (
            {
                "proposal_id": "p1-skill-route-discovery-zhengxi-views",
                "proposal_kind": "test",
        ...
        specs = (
            {
                ...
                "validation_target": "zhengxi_views_skill_route_discovery_validation_lane",
                "validation_task": (
                    "feed zhengxi-views-style agent plus skill evidence through route classification "
                    "and preserve only documentation, config, test, or code_patch lanes with local "
                    "validation required before activation"
                ),
            },
        )
    elif current_032714_window:
        specs = (
            {
                "proposal_id": "p1-skill-route-discovery-zhengxi-views",
                "proposal_kind": "test",
        ...
        specs = (
            {
                ...
                "validation_target": "zhengxi_views_skill_route_discovery_validation_lane",
                "validation_task": (
                    "verify zhengxi-style agent plus skill evidence routes only to documentation, "
                    "config, test, or code_patch lanes under skill_route_discovery before activation"
                ),
            },
        )
    elif current_235904_window:
        specs = (
            {
                "proposal_id": "p1-skill-route-discovery-compass",
                "proposal_kind": "test",
    ...
    for adjacent_row in _skill_route_discovery_adjacent_general_agent_rows(
        ...
        if current_060714_window:
            lowered_name = str(row.get("name") or "").casefold()
            if lowered_name in {"qwen-agentworld", "looper", "agentchat"}:
    ...
    review_only_anchor_proposal_id = ""
    if current_223904_window:
        review_only_anchor_proposal_id = "p5-security-agent-risk-gated-eval"
    elif current_011904_window:
        review_only_anchor_proposal_id = "p3-agent-harness-eval-looper-open-reverselab-agentchat"
    elif current_072714_window:
        review_only_anchor_proposal_id = "p4-agent-automation-eval-open-reverselab"
    elif current_084715_window:
        ...
        review_only_anchor_proposal_id = "p3_automation_agent_eval_open_reverselab"
    elif current_032714_window:
        review_only_anchor_proposal_id = "p3-general-agent-routing-coverage"
    elif current_211904_window:
    ...
    return {
        ...
        "review_only_anchor_notes": (
            [
                {
                    "proposal_id": review_only_anchor_proposal_id,
            ...
            if (
                current_223904_window
                or current_211904_window
    ...
    *,
                ...
                (
                    {
                        ...
                        "proposal_kind": "documentation",
                        "proposal_track": "skill_route_discovery_route_hint_policy",
                        "route_profiles": (
                            "generic_skill_workflow",
                            "source_cited_domain_research",
                        ),
                        "selected_local_lane": "documentation",
                        "validation_target": "skill_route_discovery_vs_agent_harness_route_hint_docs",
                        "validation_task": (
                            "document that skill_route_discovery evidence maps only to "
                            "documentation, config, test, or code_patch lanes, while adjacent "
                            "general-agent repositories require local agent_harness_eval before "
        ...
        (
            {
                ...
                "route_profiles": ("generic_skill_workflow", "skill_ecosystem_state_handoff"),
                "selected_local_lane": "documentation",
                "validation_target": "skill_route_discovery_decision_catalog",
                "validation_task": (
                    "document how skill and route evidence classifies into documentation, "
                    "config, test, or code_patch lanes without granting runtime permission"
                ),
                "expected_input_signals": (
                    "skill_markdown",
                    "skill_directory",
            ...
            {
                "proposal_id": "p2-skill-route-regression-tests",
                "proposal_kind": "test",
                "proposal_track": "skill_route_bounded_lane_regression",
                "route_profiles": ("generic_skill_workflow", "skill_ecosystem_state_handoff"),
                "selected_local_lane": "test",
                "validation_target": "skill_route_candidates_remain_bounded_to_local_validation",
                "validation_task": (
                    "assert skill-route candidates stay constrained to documentation, "
                    "config, test, or code_patch lanes and require focused local validation"
                ),
                "expected_input_signals": (
                    "skill_markdown",
                    "skill_directory",
        ...
        (
            {
                ...
                "validation_task": (
                    "feed COMPASS-style skill ecosystem evidence through route classification "
                    "and verify only documentation, config, test, or code_patch lanes remain "
                    "available with local validation required"
                ),
                "expected_input_signals": (
                    "skill_directory",
                    "skill_markdown",
            ...
            },
            {
                ...
                "validation_target": "zhengxi_generic_skill_workflow_interpretation_path",
                "validation_task": (
                    "document that generic agent plus skill workflow evidence enters "
                    "skill_route_discovery only as a bounded local validation candidate"
                ),
                "expected_input_signals": (
                    "skill_markdown",
                    "reference_directory",
    ...
    anchoring_proposal_ids = (
        ...
        [
            ...
            "p5-trend-evidence-uncertainty-template",
            "p2-agent-harness-trend-fixtures",
            "p3-agent-automation-bug-eval-lane",
            "p4-route-classification-regression-coverage",
            "p5-agent-harness-minimal-reporting",
            "trend:lyra81604/zhengxi-views-1",
            "trend:QwenLM/Qwen-AgentWorld-1",
    ...
    if (
        compass_generic_only
        and not current_103324_window
        and not current_201904_window
        and not current_213904_window
        and any(
...
def _skill_route_discovery_current_digest_pass2_operator_replay_surface(
    rows: Sequence[Mapping[str, Any]],
    adjacent_rows: Sequence[Mapping[str, Any]],
    *,
    source_digest: str,
) -> dict[str, Any]:
    """Expose pass-2 replay readiness without exporting commands or URLs."""

    skill_rows = [row for row in rows if isinstance(row, Mapping)]
    ...
    if not adjacent_ready:
        blocked_proposal_ids.append("p3-agent-harness-eval-for-general-agent-projects")
    selected_lanes = [
    ...
    replay_hashes = [
        str(row.get("replay_command_hash") or "")
        for row in [*skill_rows, *adjacent_rows]
        if str(row.get("replay_command_hash") or "")
    ]
    ready = bool(skill_rows) and not blocked_proposal_ids

    return {
        "controller_surface": "skill_route_discovery_current_digest_pass2_operator_replay_surface",
        "status": "ready" if ready else "blocked",
        "decision": (
            "pass2_skill_route_lanes_ready_for_supervisor_replay"
            if ready
            else "repair_pass2_skill_route_lanes_before_supervisor_replay"
        ),
        "source_digest": source_digest,
        "capability_pass": 2,
        "total_passes": 4,
        ...
        "blocked_proposal_ids": list(dict.fromkeys(item for item in blocked_proposal_ids if item)),
        "selected_local_lanes": [
            lane for lane in SKILL_ROUTE_DISCOVERY_ALLOWED_LANES if lane in set(selected_lanes)
        ],
        "allowed_local_lanes": list(SKILL_ROUTE_DISCOVERY_ALLOWED_LANES),
        ...
        "validation_command_hashes": list(dict.fromkeys(replay_hashes)),
        "supervisor_next_action": (
            "replay_hashed_pass2_validation_commands_then_continue_to_pass3"
            if ready
            else "repair_blocked_pass2_rows_before_replay"
        ),
        "local_validation_required": True,
        "runtime_action": "none",
        "external_skill_activation_allowed": False,
...
def _skill_route_discovery_current_digest_pass3_activation_review_lane(
    candidate_lane_inventory: Sequence[Mapping[str, Any]],
    ignored_evidence_items: Sequence[Mapping[str, Any]],
    *,
    source_digest: str,
    ...
    active_proposal_ids = (
        ...
        if current_052714_window
        else
        [
            "p1_skill_route_discovery_lane",
            "p2_agent_harness_eval_fixture",
            "p3_agent_harness_documentation",
            "p1-skill-route-discovery-zhengxi-views",
            "p2-agent-harness-eval-agentworld",
            "p3-general-agent-routing-coverage",
            "p4-agent-trend-evaluation-doc",
        ...
        (
            {
                "proposal_id": (
                    ...
                    if current_052714_window
                    else "p1_skill_route_discovery_lane"
                    if current_040714_window
                    else "p1-skill-route-discovery-zhengxi-views"
                ),
                "proposal_kind": "test",
                ...
                (
                    {
                        ...
                        "proposal_kind": "documentation",
                        "proposal_track": "trend_route_policy_documentation",
                        "route_profiles": ("generic_skill_workflow", "source_cited_domain_research"),
                        "selected_local_lane": "documentation",
                        "validation_target": "document_skill_route_vs_agent_harness_eval_boundary",
    ...
    if not has_state_handoff_evidence:
        specs = tuple(
            spec
            for spec in specs
            if set(_string_list(spec["route_profiles"])) != {"skill_ecosystem_state_handoff"}
        )
        ...
        rows.append(
            {
                ...
                "status": "ready" if not blockers else "blocked",
                "activation_blockers": blockers,
                "activation_review_step": str(spec["activation_review_step"]),
                "candidate_names": list(dict.fromkeys(name for name in candidate_names if name)),
                "candidate_source_hashes": list(dict.fromkeys(candidate_source_hashes)),
                "route_hint": SKILL_ROUTE_DISCOVERY_HINT,
                "route_class": SKILL_ROUTE_DISCOVERY_ROUTE_CLASS,
    ...
    for adjacent_row in _skill_route_discovery_adjacent_general_agent_rows(
        ...
        if current_104714_window:
            ...
            if lowered_name == "qwen-agentworld":
                ...
                row["proposal_id"] = "p2_agent_harness_eval_gate_for_general_agent_projects"
        elif current_052714_window:
            row["proposal_id"] = "proposal-agent-harness-eval-trending-agent-projects"
        elif current_024714_window:
            lowered_name = str(row.get("name") or "").casefold()
            if lowered_name == "qwen-agentworld":
                row["proposal_id"] = "p2-agent-harness-eval-qwen-agentworld"
            elif lowered_name == "looper":
        ...
        row["replay_command_hash"] = _stable_hash(replay_command) if replay_command else ""
        row["raw_replay_command_exported"] = False
        row["activation_review_step"] = "complete_agent_harness_eval_before_any_implementation_route"
        adjacent_rows.append(row)
    ...
    general_agent_row = {
        ...
        "activation_blockers": adjacent_blockers if adjacent_rows else ["general_agent_project_evidence_missing"],
        ...
        "validation_target": "general_agent_projects_require_local_harness_eval_before_routes",
        "activation_review_step": "complete_agent_harness_eval_before_documentation_test_or_code_patch",
        "replay_command_hash": _stable_hash(
            "python -m pytest tests/test_harness_eval.py -q -k agent_harness_eval_lane"
        ),
        "local_validation_required": True,
    ...
    return {
        ...
        "status": "ready" if ready else "blocked",
        "decision": (
            "current_digest_pass3_routes_ready_for_activation_review_without_runtime_authority"
            if ready
            else "repair_current_digest_pass3_routes_before_activation_review"
        ),
        "source_digest": source_digest,
        "capability_pass": 3,
        "total_passes": 4,
        ...
        "required_activation_review_evidence": [
            "selected_digest_item_ids_or_frozen_fixture",
            "bounded_lane_inventory",
            "route_profile_validation_gate",
            "metadata_only_state_handoff_boundary",
    ...
    if current_074714_window or current_090714_window or current_131922_window:
        ...
        proposal_rows = [
            ...
            *focused_agent_rows,
            _skill_route_discovery_current_digest_pass2_focused_skill_row(
                generic_row,
                proposal_id=docs_proposal_id,
                proposal_kind="documentation",
                selected_local_lane="documentation",
                validation_target="skill_route_discovery_vs_agent_harness_route_hint_docs",
            ),
        ]
    elif compass_generic_only:
        current_173904_window = source_digest == "github-growth-20260629T173904.211836Z"
        current_201904_window = source_digest == "github-growth-20260629T201904.282006Z"
        proposal_rows = [
            _skill_route_discovery_current_digest_pass2_focused_skill_row(
    ...
    *,
    ...
    index_row = _skill_route_discovery_current_digest_pass2_active_skill_row(
        ...
        validation_target=(
            ...
            if current_103324_window
            else "zhengxi_views_skill_term_evidence_routes_to_bounded_local_lanes"
            if current_074714_window or current_090714_window
    ...
    *,
    ...
    specs = (
        ...
        if current_193904_window
        else (
            {
                ...
                "selected_local_lane": "test",
                "completion_requirement": (
                    "compass_skill_ecosystem_handoff_routes_to_bounded_local_validation_without_profile_or_memory_write"
                ),
            },
            {
                "proposal_id": "p2-generic-skill-workflow-probe",
                ...
                "selected_local_lane": "documentation",
                "completion_requirement": (
                    "agent_plus_skill_repository_terms_remain_in_skill_route_discovery_bounded_lanes"
                ),
            },
        )
        if current_205904_window
        else (
            {
                ...
                "selected_local_lane": "test",
                "completion_requirement": (
                    "compass_skill_ecosystem_evidence_maps_only_to_bounded_local_validation_lanes"
                ),
            },
            {
                "proposal_id": "p2-generic-skill-route-coverage-zhengxi",
                ...
                "selected_local_lane": "documentation",
                "completion_requirement": (
                    "zhengxi_skill_workflow_terms_remain_documentation_first_before_activation"
                ),
            },
            {
                "proposal_id": "p3-agent-harness-eval-qwen-agentworld",
                "proposal_kind": "test",
                "proposal_track": "agent_project_boundary_fixture",
                "route_profiles": ("generic_skill_workflow", "skill_ecosystem_state_handoff"),
                "selected_local_lane": "test",
                "completion_requirement": (
                    "general_agent_projects_are_kept_in_agent_harness_eval_before_implementation"
                ),
            },
        )
    ...
    required_profiles = (
        ...
        if (
            ...
            or current_205904_window
            or current_233904_window
        )
        else (
            "generic_skill_workflow",
            "game_frontend_workflow",
    ...
    return {
        ...
        "anchoring_proposal_ids": (
            ...
            if current_205904_window
                ...
                "p3-route-metadata-documentation",
                "trend:dongshuyan/compass-skills-1",
                "trend:lyra81604/zhengxi-views-1",
                "trend:QwenLM/Qwen-AgentWorld-1",
                "trend:ksimback/looper-1",
...
def _skill_route_discovery_current_digest_070714_pass4_completion_handoff(
    candidate_lane_inventory: Sequence[Mapping[str, Any]],
    ignored_evidence_items: Sequence[Mapping[str, Any]],
    *,
    source_digest: str,
) -> dict[str, Any]:
    """Final pass-4 handoff for the 20260630T070714 skill-route window."""

    proposal_id = "p1_skill_route_discovery_zhengxi_views"
    adjacent_proposal_id = "p2_agent_harness_eval_general_projects"
    candidate_names: list[str] = []
    source_hashes: list[str] = []
    evidence_item_ids: list[str] = []
    route_profiles: list[str] = []
    ...
    for candidate in sorted(
        ...
        candidate_profiles = _string_list(candidate.get("route_profiles")) or ["generic_skill_workflow"]
        if "generic_skill_workflow" not in candidate_profiles:
            continue
        candidate_name = str(candidate.get("candidate_name") or "")
        if candidate_name:
            candidate_names.append(candidate_name)
        source_hashes.append(_stable_hash(str(candidate.get("source_url") or candidate_name)))
        evidence_item_ids.extend(_string_list(candidate.get("evidence_item_ids")))
        route_profiles.extend(profile for profile in candidate_profiles if profile == "generic_skill_workflow")
        allowed_lanes.extend(
            lane
            for lane in _string_list(candidate.get("proposal_kinds"))
            if lane in SKILL_ROUTE_DISCOVERY_ALLOWED_LANES
        ...
        validation_gates.extend(_skill_route_discovery_validation_gates(candidate))
        unsupported_lanes.extend(_string_list(candidate.get("downgraded_lane_names")))
        unsupported_lanes.extend(_string_list(candidate.get("unsupported_lane_pressure")))
        uncertainty_reasons.extend(_string_list(candidate.get("uncertainty_reasons")))
    ...
    row = {
        "proposal_id": proposal_id,
        "proposal_kind": "test",
        "proposal_track": "generic_skill_route_discovery_validation",
        "status": "ready" if not blockers else "blocked",
        "activation_blockers": blockers,
        "candidate_names": list(dict.fromkeys(candidate_names)),
        "candidate_source_hashes": list(dict.fromkeys(source_hashes)),
        ...
        "completion_requirement": "zhengxi_views_skill_package_signals_map_to_bounded_local_validation_lanes",
        "unsupported_lane_pressure_removed_count": len(set(unsupported_lanes)),
        "uncertainty_reasons": list(dict.fromkeys(uncertainty_reasons)),
        "accepted_outputs": ["docs", "config", "tests", "code_patch"],
        "replay_command_hash": _stable_hash(replay_command) if replay_command else "",
        "local_validation_required": True,
    ...
    adjacent_rows: list[dict[str, Any]] = []
    replay_hashes = [_stable_hash(replay_command)] if replay_command else []
    for adjacent_row in _skill_route_discovery_adjacent_general_agent_rows(
        ignored_evidence_items,
        proposal_id=adjacent_proposal_id,
    ):
        adjacent_replay_command = str(adjacent_row.get("replay_command") or "")
        exported_row = dict(adjacent_row)
        exported_row.pop("replay_command", None)
        exported_row["accepted_outputs_after_eval"] = ["docs", "tests", "code_patch"]
        exported_row["selected_local_lane"] = "agent_harness_eval_required"
        exported_row["replay_command_hash"] = _stable_hash(adjacent_replay_command) if adjacent_replay_command else ""
        exported_row["raw_replay_command_exported"] = False
        adjacent_rows.append(exported_row)
        if adjacent_replay_command:
            replay_hashes.append(_stable_hash(adjacent_replay_command))
    ...
    ready = row["status"] == "ready" and adjacent_ready and bool(adjacent_rows)
    route_boundary_checklist = _skill_route_discovery_070714_route_boundary_checklist(
        [row],
        adjacent_rows,
        source_digest=source_digest,
        ready=ready,
    ...
    return {
        ...
        "anchoring_proposal_ids": [
            ...
            "p3-agent-project-routing-docs",
            "p4-automation-agent-preflight-check",
            "trend:lyra81604/zhengxi-views-1",
            "trend:QwenLM/Qwen-AgentWorld-1",
            "trend:ksimback/looper-1",
            "trend:ziwang-Physics/AgentChat-1",
        ],
        "ready_skill_route_proposal_count": 1 if row["status"] == "ready" else 0,
        "blocked_proposal_ids": [] if row["status"] == "ready" else [proposal_id],
        "skill_route_candidate_count": len(candidate_lane_inventory),
        "adjacent_general_agent_count": len(adjacent_rows),
        "agent_harness_eval_required_count": len(adjacent_rows),
        "required_route_profiles": ["generic_skill_workflow"],
        "observed_route_profiles": [
            profile for profile in ("generic_skill_workflow",) if profile in set(route_profiles)
        ],
        "missing_required_route_profiles": [] if "generic_skill_workflow" in set(route_profiles) else ["generic_skill_workflow"],
        "selected_evidence_item_ids": list(dict.fromkeys(evidence_item_ids)),
        "allowed_local_lanes": list(SKILL_ROUTE_DISCOVERY_ALLOWED_LANES),
        "selected_local_lanes": [selected_lane] if row["status"] == "ready" else [],
        "profile_validation_checklist": _skill_route_discovery_profile_validation_checklist(
            list(dict.fromkeys(route_profiles))
        ),
        "activation_prerequisite_lane": _skill_route_discovery_activation_prerequisite_lane([row]),
        "route_boundary_checklist": route_boundary_checklist,
        "operator_completion_checklist": {
            "controller_surface": "skill_route_discovery_pass4_operator_completion_checklist",
            "status": "ready" if ready else "blocked",
            "source_digest": source_digest,
            "skill_route_rows_ready": row["status"] == "ready",
            "route_boundary_ready": route_boundary_checklist["status"] == "ready",
            "adjacent_agent_harness_gate_ready": adjacent_ready,
            "capability_slice_complete": ready,
            "replay_required_before_activation": True,
            "rollback_artifact_required": True,
...
def _skill_route_discovery_070714_route_boundary_checklist(
    rows: Sequence[Mapping[str, Any]],
    adjacent_rows: Sequence[Mapping[str, Any]],
    *,
    source_digest: str,
    ...
    return {
        ...
        "status": "ready" if ready else "blocked",
        "decision": (
            "skill_workflow_and_general_agent_routes_separated_before_handoff"
            if ready
            else "repair_skill_workflow_general_agent_boundary_before_handoff"
        ),
        "source_digest": source_digest,
...
def _skill_route_discovery_current_digest_070714_pass4_final_closure(
    candidate_lane_inventory: Sequence[Mapping[str, Any]],
    ignored_evidence_items: Sequence[Mapping[str, Any]],
    *,
    source_digest: str,
) -> dict[str, Any]:
    handoff = _skill_route_discovery_current_digest_070714_pass4_completion_handoff(
        candidate_lane_inventory,
        ignored_evidence_items,
        source_digest=source_digest,
    )
    ...
    ready = handoff["status"] == "ready" and bool(adjacent_rows)
    return {
        ...
        "capability_slice_complete": ready,
        "review_gate": "focused-evidence-review",
        "proposal_ids": ["p1_skill_route_discovery_zhengxi_views", adjacent_proposal_id],
        "ready_skill_route_proposal_count": handoff["ready_skill_route_proposal_count"],
        "blocked_proposal_ids": handoff["blocked_proposal_ids"],
        "skill_route_candidate_count": handoff["skill_route_candidate_count"],
        "observed_route_profiles": handoff["observed_route_profiles"],
        "allowed_skill_route_lanes": list(SKILL_ROUTE_DISCOVERY_ALLOWED_LANES),
        "selected_skill_route_lanes": handoff["selected_local_lanes"],
        "selected_evidence_item_ids": handoff["selected_evidence_item_ids"],
        "adjacent_general_agent_count": len(adjacent_rows),
...
def _skill_route_discovery_current_source_digest_pass3_operator_lane(
    ...
    *,
        ...
        specs = (
            {
                ...
                "route_profiles": ("skill_ecosystem_state_handoff",),
                "selected_local_lane": "test",
                "validation_target": "compass_skill_ecosystem_handoff_maps_to_bounded_local_test_lane",
            },
            {
                "proposal_id": "p2-skill-route-discovery-generic-skill-workflow",
                "proposal_kind": "test",
                "proposal_track": "generic_skill_workflow",
                "route_profiles": ("generic_skill_workflow",),
                "selected_local_lane": "test",
                "validation_target": "generic_skill_workflow_profile_maps_to_bounded_local_test_lane",
            },
        )
    elif current_191904_window:
        specs = (
            {
                "proposal_id": "p1-skill-route-discovery-compass",
                "proposal_kind": "test",
    ...
    for row in adjacent_rows:
        if current_203904_window and str(row.get("name") or "").casefold() == "looper":
            row["proposal_id"] = "p4-agent-harness-eval-looper"
        row["accepted_outputs_after_eval"] = ["docs", "tests", "code_patch"]
        row["selected_local_lane"] = "agent_harness_eval_required"
        ...
        row["validation_target"] = (
            ...
            if current_203904_window
            else "general_agent_project_trends_require_local_agent_harness_eval_before_implementation"
            if current_191904_window
        ...
        (
            {
                ...
                "route_profiles": ("skill_ecosystem_state_handoff",),
                "selected_local_lane": "test",
                "validation_target": "compass_skill_ecosystem_state_handoff_stays_metadata_only",
            },
            {
                "proposal_id": "p2-generic-skill-route-coverage-zhengxi",
                "proposal_kind": "documentation",
                ...
                "route_profiles": ("generic_skill_workflow",),
                "selected_local_lane": "documentation",
                "validation_target": "zhengxi_skill_workflow_terms_keep_local_validation_required",
            },
        )
        if current_233904_window
        else (
