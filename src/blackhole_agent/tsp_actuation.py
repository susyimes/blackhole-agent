...
def builtin_tsp_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="tsp-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, TSP_ACTUATION_GOAL, TSP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_tsp"] = (
        not gate.accepted
        and live_goal != TSP_ACTUATION_GOAL
        and TSP_ACTUATION_ID not in live_done
