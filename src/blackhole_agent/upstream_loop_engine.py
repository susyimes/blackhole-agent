...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    sub.add_parser(
        "solvency-proof",
        help=(
            "Total spine solvency: post-capital atomic SvR seals matching "
    ...
    sub.add_parser(
        "recovery-proof",
        help=(
            "Total spine recovery: post-stress atomic RvP seals matching "
            "stress books into irreversible recovery receipts"
        ),
    )
    sub.add_parser(
        "resolution-proof",
        help=(
            "Total spine resolution: post-recovery atomic RvS seals matching "
    ...
    sub.add_parser(
        ...
        help=(
            "Total spine reorganization: post-emergence atomic RvC seals matching "
            "emergence books into irreversible reorganization receipts"
        ),
    )
