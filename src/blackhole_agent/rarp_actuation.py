...
def builtin_rarp_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="rarp-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, RARP_ACTUATION_GOAL, RARP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_rarp"] = (
        not gate.accepted
        and live_goal != RARP_ACTUATION_GOAL
        and RARP_ACTUATION_ID not in live_done
