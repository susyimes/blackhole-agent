...
def builtin_total_spine_margin_proof() -> dict[str, Any]:
    ...
    try:
        ...
        source_ok = (
            getattr(le_facade, "TOTAL_SPINE_MARGIN_IMPL", None) is TOTAL_SPINE_MARGIN_IMPL
            and getattr(le_facade, "builtin_total_spine_margin_proof", None) is builtin_total_spine_margin_proof
            and getattr(le_facade, "margin_total_spine", None) is margin_total_spine
            and callable(
