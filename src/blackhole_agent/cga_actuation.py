...
def builtin_cga_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="cga-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, CGA_ACTUATION_GOAL, CGA_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_cga"] = (
        not gate.accepted
        and live_goal != CGA_ACTUATION_GOAL
        and CGA_ACTUATION_ID not in live_done
