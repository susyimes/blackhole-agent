...
def builtin_structuredfields_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="structuredfields-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, STRUCTUREDFIELDS_ACTUATION_GOAL, STRUCTUREDFIELDS_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_structuredfields"] = (
        not gate.accepted
        and live_goal != STRUCTUREDFIELDS_ACTUATION_GOAL
        and STRUCTUREDFIELDS_ACTUATION_ID not in live_done
