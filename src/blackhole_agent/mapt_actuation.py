...
def builtin_mapt_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="mapt-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, MAPT_ACTUATION_GOAL, MAPT_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_mapt"] = (
        not gate.accepted
        and live_goal != MAPT_ACTUATION_GOAL
        and MAPT_ACTUATION_ID not in live_done
