...
def builtin_hpkp_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="hpkp-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, HPKP_ACTUATION_GOAL, HPKP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_hpkp"] = (
        not gate.accepted
        and live_goal != HPKP_ACTUATION_GOAL
        and HPKP_ACTUATION_ID not in live_done
