...
def builtin_xfo_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="xfo-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, XFO_ACTUATION_GOAL, XFO_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_xfo"] = (
        not gate.accepted
        and live_goal != XFO_ACTUATION_GOAL
        and XFO_ACTUATION_ID not in live_done
