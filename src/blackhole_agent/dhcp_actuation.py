...
def builtin_dhcp_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="dhcp-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, DHCP_ACTUATION_GOAL, DHCP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_dhcp"] = (
        not gate.accepted
        and live_goal != DHCP_ACTUATION_GOAL
        and DHCP_ACTUATION_ID not in live_done
