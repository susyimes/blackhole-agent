...
def builtin_mqtt_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="mqtt-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, MQTT_ACTUATION_GOAL, MQTT_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_mqtt"] = (
        not gate.accepted
        and live_goal != MQTT_ACTUATION_GOAL
        and MQTT_ACTUATION_ID not in live_done
