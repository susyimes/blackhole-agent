...
def builtin_datachannel_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="datachannel-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, DATACHANNEL_ACTUATION_GOAL, DATACHANNEL_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_datachannel"] = (
        not gate.accepted
        and live_goal != DATACHANNEL_ACTUATION_GOAL
        and DATACHANNEL_ACTUATION_ID not in live_done
