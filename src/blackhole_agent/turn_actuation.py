...
def builtin_turn_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="turn-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, TURN_ACTUATION_GOAL, TURN_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_turn"] = (
        not gate.accepted
        and live_goal != TURN_ACTUATION_GOAL
        and TURN_ACTUATION_ID not in live_done
