...
Python quattuordecuple nested-namespace class-instance leftover:
``run_application_python_quattuordecuple_nested_namespace_class_instance_growth_plane``
constructs a class fourteen submodule levels down so a live-fetched sdist whose
covering API is ``package.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.submodule.Class().method``
rather than a thirteen-level nested ``Class().method`` instance can be foraged
the same way.

Python quindecuple nested-namespace class-instance leftover:
``run_application_python_quindecuple_nested_namespace_class_instance_growth_plane``
constructs a class fifteen submodule levels down so a live-fetched sdist whose
covering API is ``package.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.submodule.Class().method``
rather than a fourteen-level nested ``Class().method`` instance can be foraged
the same way.

Python sexdecuple nested-namespace class-instance leftover:
``run_application_python_sexdecuple_nested_namespace_class_instance_growth_plane``
constructs a class sixteen submodule levels down so a live-fetched sdist whose
...
Python octodecuple nested-namespace class-instance leftover:
``run_application_python_octodecuple_nested_namespace_class_instance_growth_plane``
constructs a class eighteen submodule levels down so a live-fetched sdist whose
covering API is ``package.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.submodule.Class().method``
rather than a seventeen-level nested ``Class().method`` instance can be foraged
the same way.

Python novemdecuple nested-namespace class-instance leftover:
``run_application_python_novemdecuple_nested_namespace_class_instance_growth_plane``
constructs a class nineteen submodule levels down so a live-fetched sdist whose
...
Python unvigintuple nested-namespace class-instance leftover:
``run_application_python_unvigintuple_nested_namespace_class_instance_growth_plane``
constructs a class twenty-one submodule levels down so a live-fetched sdist whose
covering API is ``package.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.submodule.Class().method``
rather than a twenty-level nested ``Class().method`` instance can be foraged
the same way.

Python duovigintuple nested-namespace class-instance leftover:
``run_application_python_duovigintuple_nested_namespace_class_instance_growth_plane``
constructs a class twenty-two submodule levels down so a live-fetched sdist whose
covering API is ``package.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.submodule.Class().method``
rather than a twenty-one-level nested ``Class().method`` instance can be foraged
the same way.

Python trevigintuple nested-namespace class-instance leftover:
``run_application_python_trevigintuple_nested_namespace_class_instance_growth_plane``
constructs a class twenty-three submodule levels down so a live-fetched sdist whose
covering API is ``package.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.submodule.Class().method``
rather than a twenty-two-level nested ``Class().method`` instance can be foraged
the same way.

Python quattuorvigintuple nested-namespace class-instance leftover:
``run_application_python_quattuorvigintuple_nested_namespace_class_instance_growth_plane``
constructs a class twenty-four submodule levels down so a live-fetched sdist whose
covering API is ``package.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.submodule.Class().method``
rather than a twenty-three-level nested ``Class().method`` instance can be foraged
the same way.

Python quinvigintuple nested-namespace class-instance leftover:
``run_application_python_quinvigintuple_nested_namespace_class_instance_growth_plane``
constructs a class twenty-five submodule levels down so a live-fetched sdist whose
covering API is ``package.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.submodule.Class().method``
rather than a twenty-four-level nested ``Class().method`` instance can be foraged
the same way.

Python sexvigintuple nested-namespace class-instance leftover:
``run_application_python_sexvigintuple_nested_namespace_class_instance_growth_plane``
constructs a class twenty-six submodule levels down so a live-fetched sdist whose
covering API is ``package.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.subpackage.submodule.Class().method``
rather than a twenty-five-level nested ``Class().method`` instance can be foraged
the same way.
"""
...
DEFAULT_PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-quattuordecuple-nested-namespace-class-instance-growth"
)
DEFAULT_PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG = (
    REPO_ROOT / "tests" / "fixtures" / "forage_python_quattuordecuple_nested_namespace_class_instance_catalog.json"
)
DEFAULT_PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-quindecuple-nested-namespace-class-instance-growth"
)
DEFAULT_PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG = (
    REPO_ROOT / "tests" / "fixtures" / "forage_python_quindecuple_nested_namespace_class_instance_catalog.json"
)
DEFAULT_PYTHON_SEXDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-sexdecuple-nested-namespace-class-instance-growth"
)
...
DEFAULT_PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-octodecuple-nested-namespace-class-instance-growth"
)
DEFAULT_PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG = (
    REPO_ROOT / "tests" / "fixtures" / "forage_python_octodecuple_nested_namespace_class_instance_catalog.json"
)
DEFAULT_PYTHON_NOVEMDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-novemdecuple-nested-namespace-class-instance-growth"
)
...
DEFAULT_PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-unvigintuple-nested-namespace-class-instance-growth"
)
DEFAULT_PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG = (
    REPO_ROOT / "tests" / "fixtures" / "forage_python_unvigintuple_nested_namespace_class_instance_catalog.json"
)
DEFAULT_PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-duovigintuple-nested-namespace-class-instance-growth"
)
DEFAULT_PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG = (
    REPO_ROOT / "tests" / "fixtures" / "forage_python_duovigintuple_nested_namespace_class_instance_catalog.json"
)
DEFAULT_PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-trevigintuple-nested-namespace-class-instance-growth"
)
DEFAULT_PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG = (
    REPO_ROOT / "tests" / "fixtures" / "forage_python_trevigintuple_nested_namespace_class_instance_catalog.json"
)
DEFAULT_PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-quattuorvigintuple-nested-namespace-class-instance-growth"
)
DEFAULT_PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG = (
    REPO_ROOT / "tests" / "fixtures" / "forage_python_quattuorvigintuple_nested_namespace_class_instance_catalog.json"
)
DEFAULT_PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-quinvigintuple-nested-namespace-class-instance-growth"
)
DEFAULT_PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG = (
    REPO_ROOT / "tests" / "fixtures" / "forage_python_quinvigintuple_nested_namespace_class_instance_catalog.json"
)
DEFAULT_PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ARTIFACT_DIR = (
    REPO_ROOT / "artifacts" / "capability-application-python-sexvigintuple-nested-namespace-class-instance-growth"
)
DEFAULT_PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG = (
    REPO_ROOT / "tests" / "fixtures" / "forage_python_sexvigintuple_nested_namespace_class_instance_catalog.json"
)
...
PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_codec_encode_output"
)
PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.Codec.encode"
)
PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="quattuordecuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method fourteen submodule "
        "levels down rather than a thirteen-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
    goal=(PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY,),
    oracle={
        PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY: PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE
    },
)
PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_codec_encode_output"
)
PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.Codec.encode"
)
PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="quindecuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method fifteen submodule "
        "levels down rather than a fourteen-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
    goal=(PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY,),
    oracle={
        PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY: PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE
    },
)
PYTHON_SEXDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_fermion_codec_encode_output"
)
PYTHON_SEXDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.Codec.encode"
)
PYTHON_SEXDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_SEXDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="sexdecuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method sixteen submodule "
        "levels down rather than a fifteen-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
...
PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_fermion_hadron_meson_codec_encode_output"
)
PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.Codec.encode"
)
PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="octodecuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method eighteen submodule "
        "levels down rather than a seventeen-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
    goal=(PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY,),
    oracle={
        PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY: PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE
    },
)
PYTHON_NOVEMDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_fermion_hadron_meson_baryon_codec_encode_output"
)
PYTHON_NOVEMDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.Codec.encode"
)
PYTHON_NOVEMDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_NOVEMDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="novemdecuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method nineteen submodule "
        "levels down rather than an eighteen-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
...
PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_fermion_hadron_meson_baryon_neutrino_muon_codec_encode_output"
)
PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.Codec.encode"
)
PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="unvigintuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method twenty-one submodule "
        "levels down rather than a twenty-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
    goal=(PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY,),
    oracle={
        PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY: PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE
    },
)
PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_fermion_hadron_meson_baryon_neutrino_muon_tau_codec_encode_output"
)
PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.Codec.encode"
)
PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="duovigintuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method twenty-two submodule "
        "levels down rather than a twenty-one-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
    goal=(PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY,),
    oracle={
        PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY: PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE
    },
)
PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_fermion_hadron_meson_baryon_neutrino_muon_tau_electron_codec_encode_output"
)
PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.Codec.encode"
)
PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="trevigintuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method twenty-three submodule "
        "levels down rather than a twenty-two-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
    goal=(PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY,),
    oracle={
        PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY: PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE
    },
)
PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_fermion_hadron_meson_baryon_neutrino_muon_tau_electron_positron_codec_encode_output"
)
PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.positron.Codec.encode"
)
PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="quattuorvigintuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method twenty-four submodule "
        "levels down rather than a twenty-three-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
    goal=(PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY,),
    oracle={
        PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY: PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE
    },
)
PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_fermion_hadron_meson_baryon_neutrino_muon_tau_electron_positron_neutron_codec_encode_output"
)
PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.positron.neutron.Codec.encode"
)
PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="quinvigintuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method twenty-five submodule "
        "levels down rather than a twenty-four-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
    goal=(PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY,),
    oracle={
        PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY: PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE
    },
)
PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY = (
    "codec_text_safe_inner_leaf_more_core_unit_cell_atom_quark_gluon_lepton_photon_boson_fermion_hadron_meson_baryon_neutrino_muon_tau_electron_positron_neutron_proton_codec_encode_output"
)
PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE = (
    "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.positron.neutron.proton.Codec.encode"
)
PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE = "HELLO WORLD"
PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK = ApplicationTask(
    id="sexvigintuple-nested-instance-unplannable",
    description=(
        "Unplannable application goal grown from a sdist whose covering API "
        "is a Python nested-namespace class instance method twenty-six submodule "
        "levels down rather than a twenty-five-level nested Class().method instance."
    ),
    initial_state={"text": "Hello World"},
    goal=(PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY,),
    oracle={
        PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GOAL_KEY: PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_ORACLE
    },
)
...
def _python_sextuple_nested_namespace_class_instance_selected(covering: Mapping[str, Any]) -> bool:
    from blackhole_agent.capability_foraging import python_nested_depth_flags

    callables = [str(name) for name in (covering.get("callables") or []) if str(name)]
    winner = callables[0] if callables else ""
    wanted = "python_sextuple_nested_namespace_class_instance"
    flags = python_nested_depth_flags(covering)
    return (
        bool(flags.get(wanted))
        and not any(name != wanted and value for name, value in flags.items())
...
def _load_replay_apply_catalog(path: Path) -> dict[str, Any]:
...
def _replay_synthetic_nested_codec_instance_proof(
    *,
    capability_id: str,
    leftover: str,
    ...
    inferred = _infer_synthetic_nested_codec(modules, slug)
    record = inferred.get("record") or {}
    ...
    verdicts = {
        ...
        "catalog_query": catalog.get("query") == query_from_goal(grow_task.goal),
        "infer_ok": bool(inferred.get("ok")),
        f"{selected_flag}_selected": bool(record.get(selected_flag)) and record.get("winner") == winner,
        f"winner_is_not_{prior_instance_flag}": not bool(record.get(prior_instance_flag)),
        f"winner_is_not_{static_flag}": not bool(record.get(static_flag)),
...
def _register_synthetic_nested_codec_instance_capability(
    *,
    capability_id: str,
    name: str,
    description: str,
...
def load_python_septuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_SEPTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)
...
def replay_application_python_septuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        ...
        leftover=leftover,
        modules=("codec", "text", "safe", "inner", "leaf", "more", "core"),
        slug="forage-ns-septuple-codec-instance",
        catalog=load_python_septuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_SEPTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_SEPTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_septuple_nested_namespace_class_instance",
        prior_instance_flag="python_sextuple_nested_namespace_class_instance",
        static_flag="python_septuple_nested_namespace_class_static",
...
def load_python_octuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_OCTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)
...
def replay_application_python_octuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    ...
    leftover = (
        "Optional later work is reflecting Python nested-namespace class instance methods "
        "eight submodule levels down so sdists whose covering API is an eight-level nested Class().method instance rather than a seven-level nested Class().method instance "
        "can be foraged the same way."
    )
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-oct-nested-instance-growth-plane",
        leftover=leftover,
        modules=("codec", "text", "safe", "inner", "leaf", "more", "core", "unit"),
        slug="forage-ns-octuple-codec-instance",
        catalog=load_python_octuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_OCTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_OCTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_octuple_nested_namespace_class_instance",
        prior_instance_flag="python_septuple_nested_namespace_class_instance",
        static_flag="python_octuple_nested_namespace_class_static",
...
def load_python_nonuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_NONUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)
...
def replay_application_python_nonuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    ...
    leftover = (
        "Optional later work is reflecting Python nested-namespace class instance methods "
        "nine submodule levels down so sdists whose covering API is a nine-level nested Class().method instance rather than an eight-level nested Class().method instance "
        "can be foraged the same way."
    )
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-nona-nested-instance-growth-plane",
        leftover=leftover,
        modules=("codec", "text", "safe", "inner", "leaf", "more", "core", "unit", "cell"),
        slug="forage-ns-nonuple-codec-instance",
        catalog=load_python_nonuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_NONUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_NONUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_nonuple_nested_namespace_class_instance",
        prior_instance_flag="python_octuple_nested_namespace_class_instance",
        static_flag="python_nonuple_nested_namespace_class_static",
...
def load_python_decuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_DECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)
...
def replay_application_python_decuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    ...
    leftover = (
        "Optional later work is reflecting Python nested-namespace class instance methods "
        "ten submodule levels down so sdists whose covering API is a ten-level nested Class().method instance rather than a nine-level nested Class().method instance "
        "can be foraged the same way."
    )
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-deca-nested-instance-growth-plane",
        leftover=leftover,
        modules=("codec", "text", "safe", "inner", "leaf", "more", "core", "unit", "cell", "atom"),
        slug="forage-ns-decuple-codec-instance",
        catalog=load_python_decuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_DECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_DECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_decuple_nested_namespace_class_instance",
        prior_instance_flag="python_nonuple_nested_namespace_class_instance",
        static_flag="python_decuple_nested_namespace_class_static",
...
def load_python_undecuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_UNDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)
...
def replay_application_python_undecuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    ...
    leftover = (
        "Optional later work is reflecting Python nested-namespace class instance methods "
        "eleven submodule levels down so sdists whose covering API is an eleven-level nested Class().method instance rather than a ten-level nested Class().method instance "
        "can be foraged the same way."
    )
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-undec-nested-instance-growth-plane",
        leftover=leftover,
        modules=("codec", "text", "safe", "inner", "leaf", "more", "core", "unit", "cell", "atom", "quark"),
        slug="forage-ns-undecuple-codec-instance",
        catalog=load_python_undecuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_UNDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_UNDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_undecuple_nested_namespace_class_instance",
        prior_instance_flag="python_decuple_nested_namespace_class_instance",
        static_flag="python_undecuple_nested_namespace_class_static",
...
def load_python_duodecuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_DUODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)
...
def replay_application_python_duodecuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    ...
    leftover = (
        "Optional later work is reflecting Python nested-namespace class instance methods "
        "twelve submodule levels down so sdists whose covering API is a twelve-level nested Class().method instance rather than an eleven-level nested Class().method instance "
        "can be foraged the same way."
    )
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-dodec-nested-instance-growth-plane",
        leftover=leftover,
        modules=("codec", "text", "safe", "inner", "leaf", "more", "core", "unit", "cell", "atom", "quark", "gluon"),
        slug="forage-ns-duodecuple-codec-instance",
        catalog=load_python_duodecuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_DUODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_DUODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_duodecuple_nested_namespace_class_instance",
        prior_instance_flag="python_undecuple_nested_namespace_class_instance",
        static_flag="python_duodecuple_nested_namespace_class_static",
...
def load_python_tredecuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_TREDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)
...
def replay_application_python_tredecuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    ...
    leftover = (
        "Optional later work is reflecting Python nested-namespace class instance methods "
        "thirteen submodule levels down so sdists whose covering API is a thirteen-level nested Class().method instance rather than a twelve-level nested Class().method instance "
        "can be foraged the same way."
    )
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-trede-nested-instance-growth-plane",
        leftover=leftover,
        modules=("codec", "text", "safe", "inner", "leaf", "more", "core", "unit", "cell", "atom", "quark", "gluon", "lepton"),
        slug="forage-ns-tredecuple-codec-instance",
        catalog=load_python_tredecuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_TREDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_TREDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_tredecuple_nested_namespace_class_instance",
        prior_instance_flag="python_duodecuple_nested_namespace_class_instance",
        static_flag="python_tredecuple_nested_namespace_class_static",
...
def load_python_quattuordecuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_quattuordecuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: fourteen-level Class().method instance still forages."""

    leftover = (
        "Optional later work is reflecting Python nested-namespace class instance methods "
        "fourteen submodule levels down so sdists whose covering API is a fourteen-level nested Class().method instance rather than a thirteen-level nested Class().method instance "
        "can be foraged the same way."
    )
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-quatt-nested-instance-growth-plane",
        leftover=leftover,
        modules=("codec", "text", "safe", "inner", "leaf", "more", "core", "unit", "cell", "atom", "quark", "gluon", "lepton", "photon"),
        slug="forage-ns-quattuordecuple-codec-instance",
        catalog=load_python_quattuordecuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_quattuordecuple_nested_namespace_class_instance",
        prior_instance_flag="python_tredecuple_nested_namespace_class_instance",
        static_flag="python_quattuordecuple_nested_namespace_class_static",
        action="application_python_quattuordecuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_quattuordecuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
...
def register_application_python_quattuordecuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    ledger_path = default_ledger_path(repo_root)
    ledger = load_ledger(ledger_path)
    ...
    capability = Capability(
        id="capability.application-python-quatt-nested-instance-growth-plane",
        name="Application python quattuordecuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance fourteen submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.Codec.encode as a "
            "constructable instance rather than a thirteen-level nested Class().method instance, "
            "and extra bundle leaves extract to a short cache dir so Windows MAX_PATH does "
            "not fail the forage."
        ),
        kind="python",
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_quattuordecuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_quattuordecuple_nested_namespace_class_instance_growth_plane_proof_command(),
        dependencies=dependencies,
        behavior_paths=(
            "src/blackhole_agent/capability_application_growth.py",
            "src/blackhole_agent/capability_foraging.py",
            "src/blackhole_agent/capability_acquisition.py",
            "src/blackhole_agent/capability_forage_growth.py",
            "tests/fixtures/forage_python_quattuordecuple_nested_namespace_class_instance_catalog.json",
            "capabilities/ledger.json",
        ),
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance fourteen submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.Codec.encode "
            "rather than a thirteen-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tags=(
...
def demo_application_python_quattuordecuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
    """Entry surface: grow from a fourteen-level nested-namespace class instance method."""
...
def load_python_quindecuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_quindecuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: fifteen-level Class().method instance still forages."""

    leftover = (
        "Optional later work is reflecting Python nested-namespace class instance methods "
        "fifteen submodule levels down so sdists whose covering API is a fifteen-level nested Class().method instance rather than a fourteen-level nested Class().method instance "
        "can be foraged the same way."
    )
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-quind-nested-instance-growth-plane",
        leftover=leftover,
        modules=("codec", "text", "safe", "inner", "leaf", "more", "core", "unit", "cell", "atom", "quark", "gluon", "lepton", "photon", "boson"),
        slug="forage-ns-quindecuple-codec-instance",
        catalog=load_python_quindecuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_QUINDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_quindecuple_nested_namespace_class_instance",
        prior_instance_flag="python_quattuordecuple_nested_namespace_class_instance",
        static_flag="python_quindecuple_nested_namespace_class_static",
        action="application_python_quindecuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_quindecuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
...
def register_application_python_quindecuple_nested_namespace_class_instance_growth_plane_capability(
    ...
    return _register_synthetic_nested_codec_instance_capability(
        ...
        capability_delta=(
            ...
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.Codec.encode "
            "rather than a fourteen-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
...
def demo_application_python_quindecuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
    """Entry surface: grow from a fifteen-level nested-namespace class instance method."""
...
def load_python_sexdecuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_SEXDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_sexdecuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: sixteen-level Class().method instance still forages."""
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-sexde-nested-instance-growth-plane",
        leftover=leftover,
        modules=(
            "codec",
            "text",
        ...
        slug="forage-ns-sexdecuple-codec-instance",
        catalog=load_python_sexdecuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_SEXDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_SEXDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_sexdecuple_nested_namespace_class_instance",
        prior_instance_flag="python_quindecuple_nested_namespace_class_instance",
        static_flag="python_sexdecuple_nested_namespace_class_static",
        action="application_python_sexdecuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_sexdecuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
...
def register_application_python_sexdecuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    return _register_synthetic_nested_codec_instance_capability(
        capability_id="capability.application-python-sexde-nested-instance-growth-plane",
        name="Application python sexdecuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance sixteen submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.Codec.encode "
            "as a constructable instance rather than a fifteen-level nested Class().method "
            "instance, and extra bundle leaves extract to a short cache dir so Windows "
            "MAX_PATH does not fail the forage."
        ),
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_sexdecuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_sexdecuple_nested_namespace_class_instance_growth_plane_proof_command(),
        catalog_path="tests/fixtures/forage_python_sexdecuple_nested_namespace_class_instance_catalog.json",
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance sixteen submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.Codec.encode "
            "rather than a fifteen-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tag="sexdecuple-nested",
        extra_dependencies=(
...
def demo_application_python_sexdecuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
...
def load_python_octodecuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_octodecuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: eighteen-level Class().method instance still forages."""
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-octod-nested-instance-growth-plane",
        leftover=leftover,
        modules=(
            "codec",
            "text",
        ...
        slug="forage-ns-octodecuple-codec-instance",
        catalog=load_python_octodecuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_OCTODECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_octodecuple_nested_namespace_class_instance",
        prior_instance_flag="python_septendecuple_nested_namespace_class_instance",
        static_flag="python_octodecuple_nested_namespace_class_static",
        action="application_python_octodecuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_octodecuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
        "python-octodecuple-nested-instance-proof"
    )


def register_application_python_octodecuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    return _register_synthetic_nested_codec_instance_capability(
        capability_id="capability.application-python-octod-nested-instance-growth-plane",
        name="Application python octodecuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance eighteen submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.Codec.encode "
            "as a constructable instance rather than a seventeen-level nested Class().method "
            "instance, and extra bundle leaves extract to a short cache dir so Windows "
            "MAX_PATH does not fail the forage."
        ),
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_octodecuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_octodecuple_nested_namespace_class_instance_growth_plane_proof_command(),
        catalog_path="tests/fixtures/forage_python_octodecuple_nested_namespace_class_instance_catalog.json",
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance eighteen submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.Codec.encode "
            "rather than a seventeen-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tag="octodecuple-nested",
        extra_dependencies=(
...
def demo_application_python_octodecuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
    """Entry surface: grow from an eighteen-level nested-namespace class instance method."""

    result = replay_application_python_octodecuple_nested_namespace_class_instance_growth_plane_proof()
    return {
        "ok": bool(result["ok"]),
        "winner": result.get("winner"),
        "query": result.get("query"),
...
def load_python_novemdecuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_NOVEMDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_novemdecuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: nineteen-level Class().method instance still forages."""
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-novem-nested-instance-growth-plane",
        leftover=leftover,
        modules=(
            "codec",
            "text",
        ...
        slug="forage-ns-novemdecuple-codec-instance",
        catalog=load_python_novemdecuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_NOVEMDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_NOVEMDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_novemdecuple_nested_namespace_class_instance",
        prior_instance_flag="python_octodecuple_nested_namespace_class_instance",
        static_flag="python_novemdecuple_nested_namespace_class_static",
        action="application_python_novemdecuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_novemdecuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
        "python-novemdecuple-nested-instance-proof"
    )


def register_application_python_novemdecuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    return _register_synthetic_nested_codec_instance_capability(
        capability_id="capability.application-python-novem-nested-instance-growth-plane",
        name="Application python novemdecuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance nineteen submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.Codec.encode "
            "as a constructable instance rather than an eighteen-level nested Class().method "
            "instance, and extra bundle leaves extract to a short cache dir so Windows "
            "MAX_PATH does not fail the forage."
        ),
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_novemdecuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_novemdecuple_nested_namespace_class_instance_growth_plane_proof_command(),
        catalog_path="tests/fixtures/forage_python_novemdecuple_nested_namespace_class_instance_catalog.json",
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance nineteen submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.Codec.encode "
            "rather than an eighteen-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tag="novemdecuple-nested",
        extra_dependencies=(
...
def demo_application_python_novemdecuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
...
def load_python_unvigintuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_unvigintuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: twenty-one-level Class().method instance still forages."""
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-unvig-nested-instance-growth-plane",
        leftover=leftover,
        modules=(
            "codec",
            "text",
        ...
        slug="forage-ns-unvigintuple-codec-instance",
        catalog=load_python_unvigintuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_UNVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_unvigintuple_nested_namespace_class_instance",
        prior_instance_flag="python_vigintuple_nested_namespace_class_instance",
        static_flag="python_unvigintuple_nested_namespace_class_static",
        action="application_python_unvigintuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_unvigintuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
        "python-unvigintuple-nested-instance-proof"
    )


def register_application_python_unvigintuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    return _register_synthetic_nested_codec_instance_capability(
        capability_id="capability.application-python-unvig-nested-instance-growth-plane",
        name="Application python unvigintuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance twenty-one submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.Codec.encode "
            "as a constructable instance rather than a twenty-level nested Class().method "
            "instance, and extra bundle leaves extract to a short cache dir so Windows "
            "MAX_PATH does not fail the forage."
        ),
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_unvigintuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_unvigintuple_nested_namespace_class_instance_growth_plane_proof_command(),
        catalog_path="tests/fixtures/forage_python_unvigintuple_nested_namespace_class_instance_catalog.json",
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance twenty-one submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.Codec.encode "
            "rather than a twenty-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tag="unvigintuple-nested",
        extra_dependencies=(
...
def demo_application_python_unvigintuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
    """Entry surface: grow from a twenty-one-level nested-namespace class instance method."""

    result = replay_application_python_unvigintuple_nested_namespace_class_instance_growth_plane_proof()
    return {
        "ok": bool(result["ok"]),
        "winner": result.get("winner"),
        "query": result.get("query"),
...
def load_python_duovigintuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_duovigintuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: twenty-two-level Class().method instance still forages."""
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-duovi-nested-instance-growth-plane",
        leftover=leftover,
        modules=(
            "codec",
            "text",
        ...
        slug="forage-ns-duovigintuple-codec-instance",
        catalog=load_python_duovigintuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_DUOVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_duovigintuple_nested_namespace_class_instance",
        prior_instance_flag="python_unvigintuple_nested_namespace_class_instance",
        static_flag="python_duovigintuple_nested_namespace_class_static",
        action="application_python_duovigintuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_duovigintuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
        "python-duovigintuple-nested-instance-proof"
    )


def register_application_python_duovigintuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    return _register_synthetic_nested_codec_instance_capability(
        capability_id="capability.application-python-duovi-nested-instance-growth-plane",
        name="Application python duovigintuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance twenty-two submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.Codec.encode "
            "as a constructable instance rather than a twenty-one-level nested Class().method "
            "instance, and extra bundle leaves extract to a short cache dir so Windows "
            "MAX_PATH does not fail the forage."
        ),
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_duovigintuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_duovigintuple_nested_namespace_class_instance_growth_plane_proof_command(),
        catalog_path="tests/fixtures/forage_python_duovigintuple_nested_namespace_class_instance_catalog.json",
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance twenty-two submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.Codec.encode "
            "rather than a twenty-one-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tag="duovigintuple-nested",
        extra_dependencies=(
...
def demo_application_python_duovigintuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
    """Entry surface: grow from a twenty-two-level nested-namespace class instance method."""

    result = replay_application_python_duovigintuple_nested_namespace_class_instance_growth_plane_proof()
    return {
        "ok": bool(result["ok"]),
        "winner": result.get("winner"),
        "query": result.get("query"),
...
def load_python_trevigintuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_trevigintuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: twenty-three-level Class().method instance still forages."""
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-trevi-nested-instance-growth-plane",
        leftover=leftover,
        modules=(
            "codec",
            "text",
        ...
        slug="forage-ns-trevigintuple-codec-instance",
        catalog=load_python_trevigintuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_TREVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_trevigintuple_nested_namespace_class_instance",
        prior_instance_flag="python_duovigintuple_nested_namespace_class_instance",
        static_flag="python_trevigintuple_nested_namespace_class_static",
        action="application_python_trevigintuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_trevigintuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
        "python-trevigintuple-nested-instance-proof"
    )


def register_application_python_trevigintuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    return _register_synthetic_nested_codec_instance_capability(
        capability_id="capability.application-python-trevi-nested-instance-growth-plane",
        name="Application python trevigintuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance twenty-three submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.Codec.encode "
            "as a constructable instance rather than a twenty-two-level nested Class().method "
            "instance, and extra bundle leaves extract to a short cache dir so Windows "
            "MAX_PATH does not fail the forage."
        ),
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_trevigintuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_trevigintuple_nested_namespace_class_instance_growth_plane_proof_command(),
        catalog_path="tests/fixtures/forage_python_trevigintuple_nested_namespace_class_instance_catalog.json",
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance twenty-three submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.Codec.encode "
            "rather than a twenty-two-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tag="trevigintuple-nested",
        extra_dependencies=(
...
def demo_application_python_trevigintuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
    """Entry surface: grow from a twenty-three-level nested-namespace class instance method."""

    result = replay_application_python_trevigintuple_nested_namespace_class_instance_growth_plane_proof()
    return {
        "ok": bool(result["ok"]),
        "winner": result.get("winner"),
        "query": result.get("query"),
...
def load_python_quattuorvigintuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_quattuorvigintuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: twenty-four-level Class().method instance still forages."""
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-quatv-nested-instance-growth-plane",
        leftover=leftover,
        modules=(
            "codec",
            "text",
        ...
        slug="forage-ns-quattuorvigintuple-codec-instance",
        catalog=load_python_quattuorvigintuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_QUATTUORVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_quattuorvigintuple_nested_namespace_class_instance",
        prior_instance_flag="python_trevigintuple_nested_namespace_class_instance",
        static_flag="python_quattuorvigintuple_nested_namespace_class_static",
        action="application_python_quattuorvigintuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_quattuorvigintuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
        "python-quattuorvigintuple-nested-instance-proof"
    )


def register_application_python_quattuorvigintuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    return _register_synthetic_nested_codec_instance_capability(
        capability_id="capability.application-python-quatv-nested-instance-growth-plane",
        name="Application python quattuorvigintuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance twenty-four submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.positron.Codec.encode "
            "as a constructable instance rather than a twenty-three-level nested Class().method "
            "instance, and extra bundle leaves extract to a short cache dir so Windows "
            "MAX_PATH does not fail the forage."
        ),
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_quattuorvigintuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_quattuorvigintuple_nested_namespace_class_instance_growth_plane_proof_command(),
        catalog_path="tests/fixtures/forage_python_quattuorvigintuple_nested_namespace_class_instance_catalog.json",
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance twenty-four submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.positron.Codec.encode "
            "rather than a twenty-three-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tag="quattuorvigintuple-nested",
        extra_dependencies=(
...
def demo_application_python_quattuorvigintuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
    """Entry surface: grow from a twenty-four-level nested-namespace class instance method."""

    result = replay_application_python_quattuorvigintuple_nested_namespace_class_instance_growth_plane_proof()
    return {
        "ok": bool(result["ok"]),
        "winner": result.get("winner"),
        "query": result.get("query"),
...
def load_python_quinvigintuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_quinvigintuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: twenty-five-level Class().method instance still forages."""
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-quinv-nested-instance-growth-plane",
        leftover=leftover,
        modules=(
            "codec",
            "text",
        ...
        slug="forage-ns-quinvigintuple-codec-instance",
        catalog=load_python_quinvigintuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_QUINVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_quinvigintuple_nested_namespace_class_instance",
        prior_instance_flag="python_quattuorvigintuple_nested_namespace_class_instance",
        static_flag="python_quinvigintuple_nested_namespace_class_static",
        action="application_python_quinvigintuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_quinvigintuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
        "python-quinvigintuple-nested-instance-proof"
    )


def register_application_python_quinvigintuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    return _register_synthetic_nested_codec_instance_capability(
        capability_id="capability.application-python-quinv-nested-instance-growth-plane",
        name="Application python quinvigintuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance twenty-five submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.positron.neutron.Codec.encode "
            "as a constructable instance rather than a twenty-four-level nested Class().method "
            "instance, and extra bundle leaves extract to a short cache dir so Windows "
            "MAX_PATH does not fail the forage."
        ),
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_quinvigintuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_quinvigintuple_nested_namespace_class_instance_growth_plane_proof_command(),
        catalog_path="tests/fixtures/forage_python_quinvigintuple_nested_namespace_class_instance_catalog.json",
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance twenty-five submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.positron.neutron.Codec.encode "
            "rather than a twenty-four-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tag="quinvigintuple-nested",
        extra_dependencies=(
...
def demo_application_python_quinvigintuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
    """Entry surface: grow from a twenty-five-level nested-namespace class instance method."""

    result = replay_application_python_quinvigintuple_nested_namespace_class_instance_growth_plane_proof()
    return {
        "ok": bool(result["ok"]),
        "winner": result.get("winner"),
        "query": result.get("query"),
...
def load_python_sexvigintuple_nested_namespace_class_instance_apply_catalog() -> dict[str, Any]:
    return _load_replay_apply_catalog(DEFAULT_PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CATALOG)


def replay_application_python_sexvigintuple_nested_namespace_class_instance_growth_plane_proof() -> dict[str, Any]:
    """Fast registered proof: twenty-six-level Class().method instance still forages."""
    ...
    return _replay_synthetic_nested_codec_instance_proof(
        capability_id="capability.application-python-sexvi-nested-instance-growth-plane",
        leftover=leftover,
        modules=(
            "codec",
            "text",
        ...
        slug="forage-ns-sexvigintuple-codec-instance",
        catalog=load_python_sexvigintuple_nested_namespace_class_instance_apply_catalog(),
        grow_task=PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
        winner=PYTHON_SEXVIGINTUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE,
        selected_flag="python_sexvigintuple_nested_namespace_class_instance",
        prior_instance_flag="python_quinvigintuple_nested_namespace_class_instance",
        static_flag="python_sexvigintuple_nested_namespace_class_static",
        action="application_python_sexvigintuple_nested_namespace_class_instance_growth_plane",
    )


def application_python_sexvigintuple_nested_namespace_class_instance_growth_plane_proof_command() -> str:
    return (
        "uv run python -m blackhole_agent.capability_application_growth "
        "python-sexvigintuple-nested-instance-proof"
    )


def register_application_python_sexvigintuple_nested_namespace_class_instance_growth_plane_capability(
    repo_root: Path = REPO_ROOT,
) -> dict[str, Any]:
    return _register_synthetic_nested_codec_instance_capability(
        capability_id="capability.application-python-sexvi-nested-instance-growth-plane",
        name="Application python sexvigintuple nested-namespace class-instance growth plane",
        description=(
            "An unplannable application goal grows itself from a sdist whose covering "
            "Class().method is a Python nested-namespace class instance twenty-six submodule "
            "levels down: introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.positron.neutron.proton.Codec.encode "
            "as a constructable instance rather than a twenty-five-level nested Class().method "
            "instance, and extra bundle leaves extract to a short cache dir so Windows "
            "MAX_PATH does not fail the forage."
        ),
        entry=(
            "blackhole_agent.capability_application_growth:"
            "demo_application_python_sexvigintuple_nested_namespace_class_instance_growth_plane"
        ),
        proof_command=application_python_sexvigintuple_nested_namespace_class_instance_growth_plane_proof_command(),
        catalog_path="tests/fixtures/forage_python_sexvigintuple_nested_namespace_class_instance_catalog.json",
        capability_delta=(
            "Application-growth no longer skips sdists whose covering Class().method "
            "is a Python nested-namespace class instance twenty-six submodule levels down: "
            "introspection reflects "
            "codec.text.safe.inner.leaf.more.core.unit.cell.atom.quark.gluon.lepton.photon.boson.fermion.hadron.meson.baryon.neutrino.muon.tau.electron.positron.neutron.proton.Codec.encode "
            "rather than a twenty-five-level nested Class().method instance, and extra bundle "
            "leaves extract without embedding a .whl filename so Windows MAX_PATH does "
            "not fail extra bundle leaves."
        ),
        tag="sexvigintuple-nested",
        extra_dependencies=(
...
def demo_application_python_sexvigintuple_nested_namespace_class_instance_growth_plane() -> dict[str, Any]:
    """Entry surface: grow from a twenty-six-level nested-namespace class instance method."""

    result = replay_application_python_sexvigintuple_nested_namespace_class_instance_growth_plane_proof()
    return {
        "ok": bool(result["ok"]),
        "winner": result.get("winner"),
        "query": result.get("query"),
