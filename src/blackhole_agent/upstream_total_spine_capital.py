...
def builtin_total_spine_capital_proof() -> dict[str, Any]:
    ...
    try:
        ...
        source_ok = (
            getattr(le_facade, "TOTAL_SPINE_CAPITAL_IMPL", None) is TOTAL_SPINE_CAPITAL_IMPL
            and getattr(le_facade, "builtin_total_spine_capital_proof", None) is builtin_total_spine_capital_proof
            and getattr(le_facade, "capital_total_spine", None) is capital_total_spine
            and callable(
