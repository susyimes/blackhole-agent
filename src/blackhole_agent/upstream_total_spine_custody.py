...
def builtin_total_spine_custody_proof() -> dict[str, Any]:
    ...
    try:
        ...
        source_ok = (
            getattr(le_facade, "TOTAL_SPINE_CUSTODY_IMPL", None) is TOTAL_SPINE_CUSTODY_IMPL
            and getattr(le_facade, "builtin_total_spine_custody_proof", None) is builtin_total_spine_custody_proof
            and getattr(le_facade, "custody_total_spine", None) is custody_total_spine
            and callable(
