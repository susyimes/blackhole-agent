...
def builtin_contentdisposition_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="contentdisposition-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, CONTENTDISPOSITION_ACTUATION_GOAL, CONTENTDISPOSITION_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_contentdisposition"] = (
        not gate.accepted
        and live_goal != CONTENTDISPOSITION_ACTUATION_GOAL
        and CONTENTDISPOSITION_ACTUATION_ID not in live_done
