...
def builtin_sip_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="sip-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, SIP_ACTUATION_GOAL, SIP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_sip"] = (
        not gate.accepted
        and live_goal != SIP_ACTUATION_GOAL
        and SIP_ACTUATION_ID not in live_done
