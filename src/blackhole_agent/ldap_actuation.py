...
def builtin_ldap_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="ldap-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, LDAP_ACTUATION_GOAL, LDAP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_ldap"] = (
        not gate.accepted
        and live_goal != LDAP_ACTUATION_GOAL
        and LDAP_ACTUATION_ID not in live_done
