...
def builtin_hsts_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="hsts-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, HSTS_ACTUATION_GOAL, HSTS_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_hsts"] = (
        not gate.accepted
        and live_goal != HSTS_ACTUATION_GOAL
        and HSTS_ACTUATION_ID not in live_done
