...
def builtin_lw4o6_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="lw4o6-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, LW4O6_ACTUATION_GOAL, LW4O6_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_lw4o6"] = (
        not gate.accepted
        and live_goal != LW4O6_ACTUATION_GOAL
        and LW4O6_ACTUATION_ID not in live_done
