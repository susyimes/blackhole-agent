...
def builtin_url_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="url-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, URL_ACTUATION_GOAL, URL_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_url"] = (
        not gate.accepted
        and live_goal != URL_ACTUATION_GOAL
        and URL_ACTUATION_ID not in live_done
