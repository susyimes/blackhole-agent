...
def builtin_ftp_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="ftp-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, FTP_ACTUATION_GOAL, FTP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_ftp"] = (
        not gate.accepted
        and live_goal != FTP_ACTUATION_GOAL
        and FTP_ACTUATION_ID not in live_done
