...
def builtin_dtls_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="dtls-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, DTLS_ACTUATION_GOAL, DTLS_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_dtls"] = (
        not gate.accepted
        and live_goal != DTLS_ACTUATION_GOAL
        and DTLS_ACTUATION_ID not in live_done
