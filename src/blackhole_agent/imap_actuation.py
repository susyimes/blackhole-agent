...
def builtin_imap_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="imap-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, IMAP_ACTUATION_GOAL, IMAP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_imap"] = (
        not gate.accepted
        and live_goal != IMAP_ACTUATION_GOAL
        and IMAP_ACTUATION_ID not in live_done
