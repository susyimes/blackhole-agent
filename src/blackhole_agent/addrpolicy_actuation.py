...
def builtin_addrpolicy_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="addrpolicy-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, ADDRPOLICY_ACTUATION_GOAL, ADDRPOLICY_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_addrpolicy"] = (
        not gate.accepted
        and live_goal != ADDRPOLICY_ACTUATION_GOAL
        and ADDRPOLICY_ACTUATION_ID not in live_done
