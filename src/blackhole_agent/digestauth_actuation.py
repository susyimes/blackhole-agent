...
def builtin_digestauth_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="digestauth-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, DIGESTAUTH_ACTUATION_GOAL, DIGESTAUTH_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_digestauth"] = (
        not gate.accepted
        and live_goal != DIGESTAUTH_ACTUATION_GOAL
        and DIGESTAUTH_ACTUATION_ID not in live_done
