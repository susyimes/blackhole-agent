...
def builtin_mld_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="mld-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, MLD_ACTUATION_GOAL, MLD_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_mld"] = (
        not gate.accepted
        and live_goal != MLD_ACTUATION_GOAL
        and MLD_ACTUATION_ID not in live_done
