...
def builtin_srtp_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="srtp-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, SRTP_ACTUATION_GOAL, SRTP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_srtp"] = (
        not gate.accepted
        and live_goal != SRTP_ACTUATION_GOAL
        and SRTP_ACTUATION_ID not in live_done
