...
def builtin_amqp_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="amqp-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, AMQP_ACTUATION_GOAL, AMQP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_amqp"] = (
        not gate.accepted
        and live_goal != AMQP_ACTUATION_GOAL
        and AMQP_ACTUATION_ID not in live_done
