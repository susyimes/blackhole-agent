...
def builtin_total_spine_solvency_proof() -> dict[str, Any]:
    ...
    try:
        ...
        source_ok = (
            getattr(le_facade, "TOTAL_SPINE_SOLVENCY_IMPL", None) is TOTAL_SPINE_SOLVENCY_IMPL
            and getattr(le_facade, "builtin_total_spine_solvency_proof", None) is builtin_total_spine_solvency_proof
            and getattr(le_facade, "solvency_total_spine", None) is solvency_total_spine
            and callable(
