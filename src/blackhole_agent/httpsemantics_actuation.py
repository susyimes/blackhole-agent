...
def builtin_httpsemantics_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="httpsemantics-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, HTTPSMANTICS_ACTUATION_GOAL, HTTPSMANTICS_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_httpsemantics"] = (
        not gate.accepted
        and live_goal != HTTPSMANTICS_ACTUATION_GOAL
        and HTTPSMANTICS_ACTUATION_ID not in live_done
