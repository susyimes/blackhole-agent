...
def builtin_igmp_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="igmp-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, IGMP_ACTUATION_GOAL, IGMP_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_igmp"] = (
        not gate.accepted
        and live_goal != IGMP_ACTUATION_GOAL
        and IGMP_ACTUATION_ID not in live_done
