...
def builtin_stalecontent_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="stalecontent-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, STALECONTENT_ACTUATION_GOAL, STALECONTENT_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_stalecontent"] = (
        not gate.accepted
        and live_goal != STALECONTENT_ACTUATION_GOAL
        and STALECONTENT_ACTUATION_ID not in live_done
