...
def builtin_ike_actuation_proof() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="ike-bind-") as tmp:
        ...
        gate = assess_mission_selection(root, IKE_ACTUATION_GOAL, IKE_ACTUATION_DONE_WHEN, history=[])
        live_goal, live_done, live_source = bind_gate_passing_successor(root)
    checks["exhausted_catalog_rejects_ledger_only_ike"] = (
        not gate.accepted
        and live_goal != IKE_ACTUATION_GOAL
        and IKE_ACTUATION_ID not in live_done
