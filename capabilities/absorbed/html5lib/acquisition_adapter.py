...
Generated by blackhole_agent.capability_acquisition for spec slug 'html5lib'.
...
CONFIG = {
  "callable_name": "filters.sanitizer.Filter.allowed_token",
  "entry": "",
  "extra_paths": [
  ...
  "provides": "filters_sanitizer_filter_allowed_token_output",
  "requires": [
    "token"
  ],
  "slug": "html5lib"
