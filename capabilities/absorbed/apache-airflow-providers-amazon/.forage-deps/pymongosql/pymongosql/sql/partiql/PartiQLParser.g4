...
root
    : (EXPLAIN (PAREN_LEFT explainOption (COMMA explainOption)* PAREN_RIGHT)? )? statement EOF;

statement
    : dql COLON_SEMI?         # QueryDql
    | dml COLON_SEMI?         # QueryDml
    | ddl COLON_SEMI?         # QueryDdl
    | execCommand COLON_SEMI? # QueryExec
    ;
