...
class OracleSQLHelper(SqlHelper):

    @staticmethod
    def to_sql_config(connection: Connection, **kwargs) -> Dict[str, Any]:
        """
        Transform DataZone Oracle connection data into SQL interface configuration.

        Extracts Oracle-specific parameters including region, host, port and database. Reads the contents of the
        ...
        Returns:
            Dict[str, Any]: Configuration dictionary containing:
                ...
                - database: Name of the database (service name)
        """
