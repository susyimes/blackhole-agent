...
class VerticaSQLHelper(SqlHelper):

    @staticmethod
    def to_sql_config(connection: Connection, **kwargs) -> Dict[str, Any]:
        """
        Transform Vertica connection data into SQL interface configuration.

        Extracts Vertica-specific parameters including region, host, port and database. Reads the contents of the
