...
Generated by blackhole_agent.capability_acquisition for spec slug 'html5lib-filters-sanitizer-filter-sanitize'.
...
CONFIG = {
  "callable_name": "filters.sanitizer.Filter.sanitize_css",
  "entry": "",
  "extra_paths": [
    ".forage-deps/six/six-1.17.0",
    ".forage-deps/webencodings/webencodings-0.6.1"
  ],
  "import_name": "html5lib",
  "path_root": "html5lib-1.1",
  "provides": "filters_sanitizer_filter_sanitize_css_output",
  "requires": [
    "style"
  ],
  "slug": "html5lib-filters-sanitizer-filter-sanitize"
}
