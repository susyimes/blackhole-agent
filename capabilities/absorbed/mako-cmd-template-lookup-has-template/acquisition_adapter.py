...
Generated by blackhole_agent.capability_acquisition for spec slug 'mako-cmd-template-lookup-has-template'.
...
CONFIG = {
  "callable_name": "cmd.TemplateLookup.has_template",
  "entry": "",
  "extra_paths": [
  ...
  "provides": "cmd_template_lookup_has_template_output",
  "requires": [
    "uri"
  ],
  "slug": "mako-cmd-template-lookup-has-template"
}
