...
//
// Generated by blackhole_agent.capability_acquisition for spec slug 'fast-xml-parser-xmlbuilder-replace-entitie'.
...
const CONFIG = {
  "callable_name": "XMLBuilder.replaceEntitiesValue",
  "entry": "package/src/fxp.js",
  "extra_paths": [
    ".forage-deps/strnum",
    ".forage-deps/anynum"
  ],
  "import_name": "",
  "path_root": ".",
  "provides": "xmlbuilder_replace_entities_value_output",
  "requires": [
    "arg0"
  ],
  "slug": "fast-xml-parser-xmlbuilder-replace-entitie"
};
