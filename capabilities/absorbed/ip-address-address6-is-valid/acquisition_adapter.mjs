...
//
// Generated by blackhole_agent.capability_acquisition for spec slug 'ip-address-address6-is-valid'.
...
const CONFIG = {
  "callable_name": "Address6.isValid",
  "entry": "package/dist/ip-address.js",
  "import_name": "",
  "path_root": ".",
  "provides": "address6_is_valid_output",
  "requires": [
    "arg0"
  ],
  "slug": "ip-address-address6-is-valid"
};
