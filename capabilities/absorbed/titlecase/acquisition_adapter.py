...
Generated by blackhole_agent.capability_acquisition for spec slug 'titlecase'.
...
CONFIG = {
  "callable_name": "titlecase",
  "entry": "",
  "import_name": "titlecase",
  "path_root": "titlecase-2.4.1",
  "provides": "titlecase_output",
  "requires": [
    "text"
  ],
  "slug": "titlecase"
