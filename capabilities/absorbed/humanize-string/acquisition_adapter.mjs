...
//
// Generated by blackhole_agent.capability_acquisition for spec slug 'humanize-string'.
...
const CONFIG = {
  "callable_name": "humanizeString",
  "entry": "package/index.js",
  "extra_paths": [
    ".forage-deps/decamelize"
  ],
  "import_name": "",
  "path_root": ".",
  "provides": "humanize_string_output",
  "requires": [
    "arg0"
  ],
