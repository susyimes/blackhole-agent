...
//
// Generated by blackhole_agent.capability_acquisition for spec slug 'spark-md5-hash-binary'.
...
const CONFIG = {
  "callable_name": "hashBinary",
  "entry": "package/spark-md5.js",
  "import_name": "",
  "path_root": ".",
  "provides": "hash_binary_output",
  "requires": [
    "arg0",
    "arg1"
  ],
  "slug": "spark-md5-hash-binary"
};
