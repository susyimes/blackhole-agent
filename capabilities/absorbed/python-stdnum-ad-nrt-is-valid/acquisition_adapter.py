...
Generated by blackhole_agent.capability_acquisition for spec slug 'python-stdnum-ad-nrt-is-valid'.
...
CONFIG = {
  "callable_name": "ad.nrt.is_valid",
  "entry": "",
  "import_name": "stdnum",
  "path_root": "python_stdnum-2.2",
  "provides": "ad_nrt_is_valid_output",
  "requires": [
    "number"
  ],
  "slug": "python-stdnum-ad-nrt-is-valid"
}
