...
//
// Generated by blackhole_agent.capability_acquisition for spec slug 'fast-xml-parser-xmlbuilder-close-tag'.
...
const CONFIG = {
  "callable_name": "XMLBuilder.closeTag",
  ...
  "import_name": "",
  "path_root": ".",
  "provides": "xmlbuilder_close_tag_output",
  "requires": [
    "arg0"
  ],
  "slug": "fast-xml-parser-xmlbuilder-close-tag"
};
