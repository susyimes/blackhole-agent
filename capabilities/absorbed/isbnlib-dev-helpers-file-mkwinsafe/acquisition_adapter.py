...
Generated by blackhole_agent.capability_acquisition for spec slug 'isbnlib-dev-helpers-file-mkwinsafe'.
...
CONFIG = {
  "callable_name": "dev.helpers.File.mkwinsafe",
  "entry": "",
  "import_name": "isbnlib",
  "path_root": "isbnlib-3.10.14",
  "provides": "dev_helpers_file_mkwinsafe_output",
  "requires": [
    "name"
  ],
  "slug": "isbnlib-dev-helpers-file-mkwinsafe"
}
