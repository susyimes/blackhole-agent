...
Generated by blackhole_agent.capability_acquisition for spec slug 'tomlkit-items-string-from-raw'.
...
CONFIG = {
  "callable_name": "items.String.from_raw",
  "entry": "",
  "import_name": "tomlkit",
  "path_root": "tomlkit-0.15.1",
  "provides": "items_string_from_raw_output",
  "requires": [
    "value"
  ],
  "slug": "tomlkit-items-string-from-raw"
}
