...
Generated by blackhole_agent.capability_acquisition for spec slug 'docutils'.
...
CONFIG = {
  "callable_name": "utils.math.math2html.Cloner.clone",
  "entry": "",
  "import_name": "docutils",
  "path_root": "docutils-0.23",
  "provides": "utils_math_math2html_cloner_clone_output",
  "requires": [
    "original"
  ],
  "slug": "docutils"
