...
Generated by blackhole_agent.capability_acquisition for spec slug 'tomlkit-parser-string-from-raw'.
...
CONFIG = {
  "callable_name": "parser.String.from_raw",
  "entry": "",
  "import_name": "tomlkit",
  "path_root": "tomlkit-0.15.1",
  "provides": "parser_string_from_raw_output",
  "requires": [
    "value"
  ],
  "slug": "tomlkit-parser-string-from-raw"
}
