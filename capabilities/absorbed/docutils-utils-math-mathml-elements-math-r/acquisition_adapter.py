...
Generated by blackhole_agent.capability_acquisition for spec slug 'docutils-utils-math-mathml-elements-math-r'.
...
CONFIG = {
  "callable_name": "utils.math.mathml_elements.MathRow.a_str",
  "entry": "",
  "import_name": "docutils",
  "path_root": "docutils-0.23",
  "provides": "utils_math_mathml_elements_math_row_a_str_output",
  "requires": [
    "v"
  ],
  "slug": "docutils-utils-math-mathml-elements-math-r"
}
