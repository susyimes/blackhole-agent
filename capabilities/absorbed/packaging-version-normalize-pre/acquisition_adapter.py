...
Generated by blackhole_agent.capability_acquisition for spec slug 'packaging-version-normalize-pre'.
...
CONFIG = {
  "callable_name": "version.normalize_pre",
  "entry": "",
  "import_name": "packaging",
  "path_root": "packaging-26.3/src",
  "provides": "version_normalize_pre_output",
  "requires": [
    "letter"
  ],
  "slug": "packaging-version-normalize-pre"
}
