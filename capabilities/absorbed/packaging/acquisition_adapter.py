...
Generated by blackhole_agent.capability_acquisition for spec slug 'packaging'.
...
CONFIG = {
  "callable_name": "utils.canonicalize_name",
  "entry": "",
  "import_name": "packaging",
  "path_root": "packaging-26.3/src",
  "provides": "utils_canonicalize_name_output",
  "requires": [
    "name"
  ],
  "slug": "packaging"
