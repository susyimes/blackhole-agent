...
Generated by blackhole_agent.capability_acquisition for spec slug 'isbnlib-dev-helpers-file-isfile'.
...
CONFIG = {
  "callable_name": "dev.helpers.File.isfile",
  "entry": "",
  "import_name": "isbnlib",
  "path_root": "isbnlib-3.10.14",
  "provides": "dev_helpers_file_isfile_output",
  "requires": [
    "path"
  ],
  "slug": "isbnlib-dev-helpers-file-isfile"
}
