...
//
// Generated by blackhole_agent.capability_acquisition for spec slug 'eta-eta-compile-to-string'.
...
const CONFIG = {
  "callable_name": "Eta.compileToString",
  "entry": "package/dist/index.mjs",
  "import_name": "",
  "path_root": ".",
  "provides": "eta_compile_to_string_output",
  "requires": [
    "arg0",
    "arg1"
  ],
  "slug": "eta-eta-compile-to-string"
};
