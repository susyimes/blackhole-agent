...
Generated by blackhole_agent.capability_acquisition for spec slug 'html5lib-get-tree-walker'.
...
CONFIG = {
  ...
  "provides": "get_tree_walker_output",
  "requires": [
    "tree_type"
  ],
  "slug": "html5lib-get-tree-walker"
}
