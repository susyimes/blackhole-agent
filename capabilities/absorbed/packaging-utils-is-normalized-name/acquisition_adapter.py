...
Generated by blackhole_agent.capability_acquisition for spec slug 'packaging-utils-is-normalized-name'.
...
CONFIG = {
  "callable_name": "utils.is_normalized_name",
  "entry": "",
  "import_name": "packaging",
  "path_root": "packaging-26.3/src",
  "provides": "utils_is_normalized_name_output",
  "requires": [
    "name"
  ],
  "slug": "packaging-utils-is-normalized-name"
}
