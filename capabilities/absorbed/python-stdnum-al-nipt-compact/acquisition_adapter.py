...
Generated by blackhole_agent.capability_acquisition for spec slug 'python-stdnum-al-nipt-compact'.
...
CONFIG = {
  "callable_name": "al.nipt.compact",
  "entry": "",
  "import_name": "stdnum",
  "path_root": "python_stdnum-2.2",
  "provides": "al_nipt_compact_output",
  "requires": [
    "number"
  ],
  "slug": "python-stdnum-al-nipt-compact"
}
