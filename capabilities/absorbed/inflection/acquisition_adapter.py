...
Generated by blackhole_agent.capability_acquisition for spec slug 'inflection'.
...
CONFIG = {
  "callable_name": "camelize",
  "entry": "",
  "import_name": "inflection",
  "path_root": "inflection-0.5.1",
  "provides": "camelize_output",
  "requires": [
    "string"
  ],
  "slug": "inflection"
