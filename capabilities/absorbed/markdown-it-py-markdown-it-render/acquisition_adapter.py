...
Generated by blackhole_agent.capability_acquisition for spec slug 'markdown-it-py-markdown-it-render'.
...
CONFIG = {
  "callable_name": "MarkdownIt.render",
  "entry": "",
  "extra_paths": [
  ...
  "provides": "markdown_it_render_output",
  "requires": [
    "src"
  ],
  "slug": "markdown-it-py-markdown-it-render"
}
