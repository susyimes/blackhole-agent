...
def test_builtin_proof_speaks_argument_completion() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_completions"]
...
def test_selection_gate_rejects_ledger_only_completions_family(tmp_path: Path) -> None:
