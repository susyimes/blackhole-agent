...
def test_builtin_proof_cancels_in_flight_tools_call() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_cancellation"]
...
def test_selection_gate_rejects_ledger_only_cancellation_family(tmp_path: Path) -> None:
