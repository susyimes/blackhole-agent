...
def test_builtin_proof_seals_github_actuation() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_github"]
...
def test_selection_gate_rejects_ledger_only_git_publication_family(tmp_path: Path) -> None:
