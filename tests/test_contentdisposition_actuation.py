...
def test_builtin_proof_seals_contentdisposition_actuation() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_contentdisposition"]
...
def test_selection_gate_rejects_ledger_only_contentdisposition_family(tmp_path: Path) -> None:
