...
def test_builtin_proof_seals_httpsemantics_actuation() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_httpsemantics"]
...
def test_selection_gate_rejects_ledger_only_httpsemantics_family(tmp_path: Path) -> None:
