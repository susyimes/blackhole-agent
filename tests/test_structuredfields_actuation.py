...
def test_builtin_proof_seals_structuredfields_actuation() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_structuredfields"]
...
def test_selection_gate_rejects_ledger_only_structuredfields_family(tmp_path: Path) -> None:
