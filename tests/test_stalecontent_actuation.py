...
def test_builtin_proof_seals_stalecontent_actuation() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_stalecontent"]
...
def test_selection_gate_rejects_ledger_only_stalecontent_family(tmp_path: Path) -> None:
