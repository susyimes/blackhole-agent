"""Tests for fourteen-level nested-namespace Python class-instance forage."""
...
from blackhole_agent.capability_application_growth import (
    ...
    PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK,
    load_python_quattuordecuple_nested_namespace_class_instance_apply_catalog,
    replay_application_python_quattuordecuple_nested_namespace_class_instance_growth_plane_proof,
)
...
def test_python_quattuordecuple_nested_namespace_class_instance_catalog_query() -> None:
    catalog = load_python_quattuordecuple_nested_namespace_class_instance_apply_catalog()
    assert catalog["query"] == query_from_goal(PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_GROW_TASK.goal)
...
def test_python_quattuordecuple_nested_namespace_class_instance_replay_proof() -> None:
    result = replay_application_python_quattuordecuple_nested_namespace_class_instance_growth_plane_proof()
    assert result["ok"], result
    assert result["action"] == "application_python_quattuordecuple_nested_namespace_class_instance_growth_plane"
    assert result["python_quattuordecuple_nested_namespace_class_instance_selected"]
    assert result["winner"] == PYTHON_QUATTUORDECUPLE_NESTED_NAMESPACE_CLASS_INSTANCE_CALLABLE
    leftover = (
