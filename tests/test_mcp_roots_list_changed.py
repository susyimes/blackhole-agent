...
def test_builtin_proof_speaks_worktree_roots_plane() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_roots_changed"]
...
def test_selection_gate_rejects_ledger_only_worktree_family(tmp_path: Path) -> None:
