...
def test_local_harness_eval_runs_pass_and_fail_fixtures_without_exporting_inputs():
    ...
    assert payload["fixture_count"] == 139
    assert payload["pass_count"] == 138
    ...
    assert results["skill-route-discovery-current-digest-20260629T002729-pass1-bounded-lane"]["passed"] is True
    assert results["skill-route-discovery-current-digest-20260629T061942-pass1-current-window"]["passed"] is True
    assert (
        results[
            "skill-route-discovery-current-digest-20260629T183904-pass1-local-skill-route-validation"
        ]["passed"]
        is True
    )
    assert (
    ...
    assert (
        results[
            "skill-route-discovery-current-digest-20260629T223904-pass1-validation-lane"
        ]["passed"]
        is True
    )
    assert (
    ...
    assert (
        results[
            "skill-route-discovery-current-digest-20260630T001904-pass2-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260630T011904-pass1-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260630T024714-pass3-empty-hint-general-agent-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260630T032714-pass1-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260630T034714-pass2-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
    ...
    assert (
        results[
            "skill-route-discovery-current-digest-20260701T104533-pass1-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260701T141923-pass1-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260701T153922-pass1-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260701T165922-pass1-current-lane"
        ]["passed"]
        is True
    )
    assert (
    ...
    assert (
        results[
            "skill-route-discovery-current-digest-20260701T190302-pass3-current-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260701T200302-pass2-manifest-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260701T202302-pass3-activation-review-lane"
        ]["passed"]
        is True
    )
    assert (
    ...
    assert (
        results[
            "skill-route-discovery-current-digest-20260702T034714-pass2-operator-manifest"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260702T044714-pass1-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260702T050714-pass2-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260702T062714-pass2-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260702T100715-pass1-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260702T102714-pass2-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260702T104714-pass3-activation-review-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260702T134626-pass4-completion"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260701T231748-pass3-activation-review-lane"
        ]["passed"]
        is True
    )
    assert (
    ...
    assert (
        results[
            "skill-route-discovery-current-digest-20260630T060714-pass1-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
        results[
            "skill-route-discovery-current-digest-20260630T072714-pass1-local-validation-lane"
        ]["passed"]
        is True
    )
    assert (
...
def test_skill_route_discovery_current_pass2_batch_validation_lane_handles_adjacent_agent_eval():
    fixture_path = LOCAL_EVAL_FIXTURE_DIR / "skill_route_discovery_current_pass2_batch_validation_lane.json"
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    packet = output["current_pass2_validation_lane"]
    serialized = json.dumps(packet, sort_keys=True)

    assert output["route_status"] == "passed"
    assert output["registry"]["candidate_count"] == 3
    assert output["registry"]["ignored_evidence_item_count"] == 2
    assert packet["controller_surface"] == "skill_route_discovery_current_pass2_validation_lane"
    assert packet["status"] == "ready"
    assert packet["source_digest"] == "github-growth-20260628T084729.600885Z"
    assert packet["required_route_profiles"] == [
        "generic_skill_workflow",
        "game_frontend_workflow",
        "skill_ecosystem_state_handoff",
    ]
    assert packet["missing_required_route_profiles"] == []
    ...
    assert all(row["external_harness_execution_allowed"] is False for row in packet["adjacent_general_agent_rows"])
    assert all(
        set(row["allowed_local_lanes"]) <= {"documentation", "test", "code_patch"}
...
def test_skill_route_discovery_current_digest_20260629T205904_pass4_completion_is_ready():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
    ...
    assert handoff["source_digest"] == "github-growth-20260629T205904.286797Z"
    assert handoff["status"] == "ready"
    assert handoff["selected_local_lanes"] == ["config", "documentation"]
    assert handoff["route_profiles"] == [
        "generic_skill_workflow",
        "skill_ecosystem_state_handoff",
    ]
    ...
    assert proposal_summary["agent_harness_eval_row_count"] == 1
    assert proposal_summary["selected_skill_route_lanes"] == ["documentation", "config"]
    assert proposal_summary["route_profiles"] == [
        "generic_skill_workflow",
        "skill_ecosystem_state_handoff",
    ]
...
def test_skill_route_discovery_current_digest_20260629_pass1_bounded_lane_routes_agent_eval_adjacent():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
    ...
    assert [row["name"] for row in adjacent] == ["Qwen-AgentWorld", "looper"]
    assert all(row["proposal_id"] == "p3-agent-harness-eval-general-projects" for row in adjacent)
    assert all(row["evaluation_lane"] == "agent_harness_eval_required" for row in adjacent)
    assert all(row["skill_route_discovery_inherited"] is False for row in adjacent)
    assert all(row["direct_runtime_route_allowed"] is False for row in adjacent)
    assert all(row["direct_code_patch_route_allowed"] is False for row in adjacent)
...
def test_skill_route_discovery_current_digest_20260629T061942_pass1_current_window_routes_carried_evidence():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260629T061942_pass1_current_window.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 2
    assert output["registry"]["ignored_evidence_item_count"] == 2
    assert panel["source_digest"] == "github-growth-20260629T061942.961537Z"
    assert panel["proposal_ids"] == [
    ...
    assert rows["p1-skill-route-discovery-compass-skills"]["candidate_names"] == [
        "compass-skills"
    ]
    ...
    assert rows["p2-skill-route-discovery-zhengxi-views"]["candidate_names"] == [
        "zhengxi-views"
    ]
    ...
    assert [row["item_id"] for row in adjacent] == [
        "p3-agent-harness-qwen-agentworld:repository",
        "p3-agent-harness-qwen-agentworld:issue-2",
    ]
    assert all(row["proposal_id"] == "p3-agent-harness-qwen-agentworld" for row in adjacent)
    assert all(row["evaluation_lane"] == "agent_harness_eval_required" for row in adjacent)
    assert all(row["skill_route_discovery_inherited"] is False for row in adjacent)
    assert all(row["direct_runtime_route_allowed"] is False for row in adjacent)
    assert all(row["direct_code_patch_route_allowed"] is False for row in adjacent)
...
def test_skill_route_discovery_current_digest_20260629T183904_pass1_local_skill_route_validation():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260629T183904_pass1_local_skill_route_validation.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 2
    assert output["registry"]["ignored_evidence_item_count"] == 2
    assert panel["source_digest"] == "github-growth-20260629T183904.255941Z"
    assert panel["proposal_ids"] == [
        "p1-skill-route-discovery-compass-skills",
        "p2-skill-route-discovery-zhengxi-views",
    ]
    ...
    zhengxi = rows["p2-skill-route-discovery-zhengxi-views"]
    assert compass["candidate_names"] == ["compass-skills"]
    assert compass["route_hint"] == "skill_route_discovery"
    ...
    assert zhengxi["route_hint"] == "skill_route_discovery"
...
def test_skill_route_discovery_current_digest_20260629T223904_pass1_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260629T223904_pass1_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 2
    assert output["registry"]["ignored_evidence_item_count"] == 2
    assert lane["source_digest"] == "github-growth-20260629T223904.363629Z"
    assert lane["proposal_ids"] == [
        "p1-skill-route-discovery-compass",
...
def test_skill_route_discovery_current_digest_20260629T225904_pass2_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260629T225904_pass2_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 2
    assert output["registry"]["ignored_evidence_item_count"] == 2
    assert lane["source_digest"] == "github-growth-20260629T225904.339664Z"
    ...
    assert lane["anchoring_proposal_ids"] == [
        ...
        "p4-agent-harness-eval-looper",
        "p5-security-agent-review-harness-autocve",
        "trend:dongshuyan/compass-skills-1",
        "trend:lyra81604/zhengxi-views-1",
        "trend:QwenLM/Qwen-AgentWorld-1",
        "trend:ksimback/looper-1",
...
def test_skill_route_discovery_current_digest_20260630T001904_pass2_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260630T001904_pass2_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 2
    assert output["registry"]["ignored_evidence_item_count"] == 2
    assert lane["source_digest"] == "github-growth-20260630T001904.371161Z"
    assert lane["capability_pass"] == 2
    assert lane["proposal_ids"] == [
        "p1-skill-route-discovery-compass",
...
def test_skill_route_discovery_current_digest_20260630T011904_pass1_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260630T011904_pass1_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert lane["source_digest"] == "github-growth-20260630T011904.386176Z"
    assert lane["capability_pass"] == 1
    assert lane["status"] == "ready"
    assert lane["proposal_ids"] == ["p1-skill-route-discovery-zhengxi-views"]
    assert lane["anchoring_proposal_ids"] == [
        "p1-skill-route-discovery-zhengxi-views",
        "p2-agent-harness-eval-qwen-agentworld",
    ...
    assert lane["review_only_anchor_notes"] == [
        {
            "proposal_id": "p3-agent-harness-eval-looper-open-reverselab-agentchat",
            "evidence_class": "security_agent_context",
            "route_influence": "none",
            "review_reason": "offensive_behavior_boundary",
            "local_validation_required": True,
...
def test_skill_route_discovery_current_digest_20260630T032714_pass1_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260630T032714_pass1_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260630T032714.526268Z"
    assert lane["capability_pass"] == 1
    assert lane["status"] == "ready"
    assert lane["proposal_ids"] == ["p1-skill-route-discovery-zhengxi-views"]
    assert lane["anchoring_proposal_ids"] == [
...
def test_skill_route_discovery_current_digest_20260630T060714_pass1_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
    ...
    assert lane["source_digest"] == "github-growth-20260630T060714.387302Z"
    assert lane["capability_pass"] == 1
    assert lane["status"] == "ready"
...
def test_skill_route_discovery_current_digest_20260630T072714_pass1_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260630T072714_pass1_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260630T072714.658769Z"
    assert lane["capability_pass"] == 1
    assert lane["status"] == "ready"
    assert lane["proposal_ids"] == ["p1-skill-route-discovery-zhengxi-views"]
    assert lane["anchoring_proposal_ids"] == [
...
def test_skill_route_discovery_current_digest_20260630T034714_pass2_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260630T034714_pass2_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert output["preactivation_trust_boundary"]["status"] == "passed"
    assert lane["source_digest"] == "github-growth-20260630T034714.764347Z"
    assert lane["capability_pass"] == 2
    assert lane["status"] == "ready"
    assert lane["proposal_ids"] == ["p1-skill-route-discovery-zhengxi-views"]
...
def test_skill_route_discovery_current_digest_20260630T040714_pass3_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260630T040714_pass3_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260630T040714.847135Z"
    ...
    harness = rows["p2_agent_harness_eval_fixture"]
    assert zhengxi["candidate_names"] == ["zhengxi-views"]
    assert zhengxi["selected_local_lane"] == "test"
    assert set(zhengxi["allowed_local_lanes"]) == {"documentation", "config", "test", "code_patch"}
    assert zhengxi["runtime_action"] == "none"
...
def test_skill_route_discovery_current_digest_20260630T080714_pass3_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260630T080714_pass3_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260630T080714.700772Z"
    assert lane["capability_pass"] == 3
    assert lane["status"] == "ready"
    assert lane["proposal_ids"] == [
        "p1_skill_route_discovery_probe_zhengxi_views",
        "p2_agent_harness_eval_gate_for_general_agent_projects",
    ]
    assert lane["active_proposal_ids"][:5] == [
        "p1_skill_route_discovery_probe_zhengxi_views",
        "p2_agent_harness_eval_gate_for_general_agent_projects",
        "p3_document_route_policy_for_trend_only_inputs",
        "p1-skill-route-discovery-zhengxi-views",
        "p2-agent-harness-eval-qwen-agentworld",
    ]

    zhengxi = rows["p1_skill_route_discovery_probe_zhengxi_views"]
    harness = rows["p2_agent_harness_eval_gate_for_general_agent_projects"]
    assert zhengxi["candidate_names"] == ["zhengxi-views"]
    assert zhengxi["selected_local_lane"] == "test"
...
def test_skill_route_discovery_current_digest_20260701T104533_pass1_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260701T104533_pass1_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260701T104533.288698Z"
    assert lane["capability_pass"] == 1
    assert lane["status"] == "ready"
    assert lane["proposal_ids"] == ["p1-skill-route-discovery-zhengxi-views"]
    ...
    assert all(row["direct_runtime_route_allowed"] is False for row in adjacent)
    assert all(row["direct_code_patch_route_allowed"] is False for row in adjacent)
    assert all(row["external_agent_activation_allowed"] is False for row in adjacent)
    assert all(row["external_harness_execution_allowed"] is False for row in adjacent)
    assert all(row["provider_runtime_launch_allowed"] is False for row in adjacent)
...
def test_skill_route_discovery_current_digest_20260701T141923_pass1_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260701T141923_pass1_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260701T141923.059729Z"
    assert lane["capability_pass"] == 1
    assert lane["status"] == "ready"
    assert lane["proposal_ids"] == ["p1-skill-route-discovery-zhengxi-views"]
    assert lane["anchoring_proposal_ids"] == [
    ...
    assert lane["review_only_anchor_notes"] == [
        {
            "proposal_id": "p3-agent-harness-comparison-set",
            "evidence_class": "security_agent_context",
            "route_influence": "none",
            "review_reason": "offensive_behavior_boundary",
            "local_validation_required": True,
...
def test_skill_route_discovery_current_digest_20260701T153922_pass1_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260701T153922.962740Z"
    assert lane["capability_pass"] == 1
    assert lane["status"] == "ready"
    assert lane["proposal_ids"] == ["p1_skill_route_discovery_lane"]
    assert lane["anchoring_proposal_ids"] == [
        "p1_skill_route_discovery_lane",
        "p2_agent_harness_eval_fixture",
        "p3_agent_automation_bug_eval",
        "p4_route_policy_documentation",
        "trend:lyra81604/zhengxi-views-1",
        "trend:QwenLM/Qwen-AgentWorld-1",
        "trend:TianhangZhuzth/Fundamental-Ava-1",
        "trend:ksimback/looper-1",
    ...
    assert lane["review_only_anchor_notes"] == [
        {
            "proposal_id": "p3_agent_automation_bug_eval",
            "evidence_class": "security_agent_context",
            "route_influence": "none",
            "review_reason": "offensive_behavior_boundary",
            "local_validation_required": True,
...
def test_skill_route_discovery_current_digest_20260701T143923_pass2_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260701T143923.018624Z"
    assert lane["capability_pass"] == 2
    assert lane["status"] == "ready"
    assert lane["proposal_ids"] == [
    ...
    zhengxi = rows["p1-skill-route-discovery-validation"]
    docs = rows["p3-agent-harness-docs"]
    assert zhengxi["candidate_names"] == ["zhengxi-views"]
    assert zhengxi["route_profiles"] == [
        "generic_skill_workflow",
        "source_cited_domain_research",
...
def test_skill_route_discovery_current_digest_20260701T190302_pass3_current_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260701T190302_pass3_current_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert rows["p1_skill_route_discovery_zhengxi_views"]["allowed_local_lanes"] == [
        "documentation",
        "config",
        "test",
        "code_patch",
    ]
    assert rows["p1_skill_route_discovery_zhengxi_views"]["selected_local_lane"] == "test"
    assert rows["p3-route-classification-docs"]["selected_local_lane"] == "documentation"
    assert rows["p2-agent-harness-eval-suite"]["selected_local_lane"] == "agent_harness_eval_required"
    assert rows["p2-agent-harness-eval-suite"]["direct_local_change_proposals_allowed_before_eval"] is False
    ...
    assert gate["status"] == "ready"
    assert gate["selected_skill_route_lanes"] == ["documentation", "test"]
    assert gate["agent_harness_eval_required_count"] == 3
    assert gate["runtime_action_allowed"] is False
    assert lane["runtime_action"] == "none"
    assert lane["external_skill_activation_allowed"] is False
...
def test_skill_route_discovery_current_digest_20260701T202302_pass3_activation_review_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260701T202302_pass3_activation_review_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert rows["p1_skill_route_discovery_zhengxi_views"]["selected_local_lane"] == "test"
    assert rows["p4_document_route_policy_for_trend_only_evidence"]["selected_local_lane"] == "documentation"
    assert rows["p2-agent-harness-eval-trending-agent-projects"]["selected_local_lane"] == (
        "agent_harness_eval_required"
    )
    assert rows["p2-agent-harness-eval-trending-agent-projects"][
        "direct_local_change_proposals_allowed_before_eval"
    ] is False
    ...
    assert gate["status"] == "ready"
    assert gate["selected_skill_route_lanes"] == ["documentation", "test"]
    assert gate["agent_harness_eval_required_count"] == 4
    assert gate["automation_or_bug_agent_harness_eval_required_count"] == 1
    assert gate["runtime_action_allowed"] is False
    assert lane["review_only_anchor_notes"][0]["review_reason"] == "offensive_behavior_boundary"
    assert lane["runtime_action"] == "none"
...
def test_skill_route_discovery_current_digest_20260701T204302_pass4_completion_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260701T204302_pass4_completion.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
...
def test_skill_route_discovery_current_digest_20260702T050714_pass2_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260702T050714_pass2_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 2
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260702T050714.674520Z"
    assert lane["proposal_ids"] == [
    ...
    assert all(row["direct_runtime_route_allowed"] is False for row in adjacent.values())
    assert all(row["direct_code_patch_route_allowed"] is False for row in adjacent.values())
    assert lane["acceptance_surface"]["agent_harness_eval_required_count"] == 3
...
def test_skill_route_discovery_current_digest_20260701T215748_pass3_route_to_validation():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260701T215748_pass3_route_to_validation.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["route_status"] == "passed"
    assert lane["source_digest"] == "github-growth-20260701T215748.459700Z"
    assert lane["proposal_ids"] == [
        "p1_skill_route_discovery_zhengxi_views",
    ...
    assert lane["rows"][0]["candidate_names"] == ["zhengxi-views"]
    assert lane["rows"][0]["allowed_local_lanes"] == ["documentation", "config", "test", "code_patch"]
    assert lane["rows"][0]["runtime_action"] == "none"
    assert set(adjacent) == {"Qwen-AgentWorld", "Fundamental-Ava", "looper"}
    assert adjacent["Qwen-AgentWorld"]["proposal_id"] == "p2_agent_harness_eval_agentworld"
    assert adjacent["Fundamental-Ava"]["proposal_id"] == "p3_agent_harness_eval_fundamental_ava"
    assert adjacent["looper"]["proposal_id"] == "p4_agent_harness_eval_looper"
    ...
    assert lane["review_only_anchor_notes"] == [
        {
            "proposal_id": "p5_agent_harness_eval_open_reverselab",
...
def test_skill_route_discovery_current_digest_20260630T084715_pass1_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260630T084715_pass1_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260630T084715.195137Z"
    assert lane["capability_pass"] == 1
    assert lane["proposal_ids"] == ["p1-skill-route-discovery-zhengxi-views"]
    assert lane["anchoring_proposal_ids"] == [
        "p1-skill-route-discovery-zhengxi-views",
...
def test_skill_route_discovery_current_digest_20260630T024714_pass3_empty_hint_general_agent_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260630T024714_pass3_empty_hint_general_agent_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 2
    assert lane["source_digest"] == "github-growth-20260630T024714.466980Z"
    assert lane["capability_pass"] == 3
    assert lane["proposal_ids"] == [
        "p1-skill-route-discovery-zhengxi-views",
        "p2-agent-harness-eval-qwen-agentworld",
    ...
    zhengxi = rows["p1-skill-route-discovery-zhengxi-views"]
    harness = rows["p2-agent-harness-eval-qwen-agentworld"]
    assert zhengxi["candidate_names"] == ["zhengxi-views"]
    assert zhengxi["selected_local_lane"] == "test"
    assert set(zhengxi["allowed_local_lanes"]) == {"documentation", "config", "test", "code_patch"}
    assert harness["route_hint"] == "agent_harness_eval_required"
    assert harness["candidate_names"] == ["Qwen-AgentWorld", "looper"]
    assert harness["direct_local_change_proposals_allowed_before_eval"] is False
...
def test_skill_route_discovery_current_digest_20260702T100715_pass1_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260702T100715_pass1_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260702T100715.355760Z"
    assert lane["proposal_ids"] == ["p1_skill_route_discovery_zhengxi_views"]
    assert lane["selected_local_lanes"] == ["test"]
    assert lane["agent_harness_eval_required_count"] == 3
    ...
    assert [row["name"] for row in adjacent] == ["Qwen-AgentWorld", "Fundamental-Ava", "looper"]
    assert all(row["proposal_id"] == "p2_agent_harness_eval_trending_agents" for row in adjacent)
    assert all(row["evaluation_lane"] == "agent_harness_eval_required" for row in adjacent)
    assert all(row["skill_route_discovery_inherited"] is False for row in adjacent)
    assert all(row["direct_runtime_route_allowed"] is False for row in adjacent)
    assert all(row["direct_code_patch_route_allowed"] is False for row in adjacent)
...
def test_skill_route_discovery_current_digest_20260702T102714_pass2_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260702T102714_pass2_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
...
def test_skill_route_discovery_current_digest_20260702T154626_pass2_local_validation_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260702T154626_pass2_local_validation_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 2
    assert lane["source_digest"] == "github-growth-20260702T154626.821848Z"
    assert lane["proposal_ids"] == [
    ...
    assert rows["p2-agent-harness-eval-for-general-agent-trends"]["selected_local_lane"] == "test"
    assert [row["name"] for row in adjacent] == ["Qwen-AgentWorld", "Fundamental-Ava"]
    assert all(row["evaluation_lane"] == "agent_harness_eval_required" for row in adjacent)
    assert all(row["skill_route_discovery_inherited"] is False for row in adjacent)
    assert all(row["direct_runtime_route_allowed"] is False for row in adjacent)
    assert all(row["direct_code_patch_route_allowed"] is False for row in adjacent)
...
def test_skill_route_discovery_current_digest_20260702T104714_pass3_activation_review_lane():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260702T104714_pass3_activation_review_lane.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    lane = output["current_digest_pass3_activation_review_lane"]
    rows = {row["proposal_id"]: row for row in lane["rows"]}
    matrix = lane["adjacent_agent_harness_eval_matrix"]
    serialized = json.dumps(lane, sort_keys=True)

    assert output["route_status"] == "passed"
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert lane["source_digest"] == "github-growth-20260702T104714.732349Z"
    assert lane["proposal_ids"] == [
        "p1-skill-route-discovery-zhengxi-views",
        "p2-agent-harness-eval-general-agent-projects",
    ...
    assert [row["name"] for row in matrix] == ["Qwen-AgentWorld", "Fundamental-Ava", "looper"]
    assert all(row["proposal_id"] == "p2-agent-harness-eval-general-agent-projects" for row in matrix)
    assert all(row["implementation_lanes_enabled"] is False for row in matrix)
    assert all(row["skill_route_discovery_inherited"] is False for row in matrix)
    assert all(row["direct_runtime_route_allowed"] is False for row in matrix)
    assert all(row["direct_code_patch_route_allowed"] is False for row in matrix)
...
def test_skill_route_discovery_current_digest_20260702T134626_pass4_completion():
    fixture_path = (
        LOCAL_EVAL_FIXTURE_DIR
        / "skill_route_discovery_current_digest_20260702T134626_pass4_completion.json"
    )
    fixture = json.loads(fixture_path.read_text(encoding="utf-8"))
    ...
    assert output["registry"]["candidate_count"] == 1
    assert output["registry"]["ignored_evidence_item_count"] == 3
    assert handoff["source_digest"] == "github-growth-20260702T134626.866283Z"
    assert handoff["proposal_ids"] == [
        "p1-skill-route-discovery-zhengxi-views",
        "p2-agent-harness-eval-fixtures",
        "p3-document-agent-growth-routing-policy",
    ]
    assert handoff["selected_local_lanes"] == ["documentation", "test"]
    assert handoff["agent_harness_eval_required_count"] == 3
    ...
    docs_row = rows["p3-document-agent-growth-routing-policy"]
    assert docs_row["selected_local_lane"] == "documentation"
    assert docs_row["completion_requirement"] == (
        "route_policy_distinguishes_skill_workflow_discovery_from_general_agent_eval"
    )
