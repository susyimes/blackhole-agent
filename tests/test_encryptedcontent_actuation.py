...
def test_builtin_proof_seals_encryptedcontent_actuation() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_encryptedcontent"]
...
def test_selection_gate_rejects_ledger_only_encryptedcontent_family(tmp_path: Path) -> None:
