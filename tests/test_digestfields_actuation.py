...
def test_builtin_proof_seals_digestfields_actuation() -> None:
    ...
    assert report["checks"]["exhausted_catalog_rejects_ledger_only_digestfields"]
...
def test_selection_gate_rejects_ledger_only_digestfields_family(tmp_path: Path) -> None:
