"""Standalone repro for the inline-element rescan quadratic defect (complexity).

Discovered autonomously by blackhole_agent.upstream_discovery (generator
'inline_links': n valid inline links in one paragraph; the inline tree
processor rebuilds and rescans the whole text node after every accepted
match). Runs a doubling ladder against the source tree given as argv[1];
exits 1 while the defect is present, 0 once repaired.
Usage: python <this file> <path-to-src-dir>
"""
